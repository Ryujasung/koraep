...
<script src="/js/kora/paging_common.js"></script>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF0140101.do";
			kora.common.goPage('/MF/EPMF8716231.do', INQ_PARAMS);
		}
		...
		function fn_page(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF0140101.do";
			kora.common.goPage('/MF/EPMF0140164.do', INQ_PARAMS);
		}
		...
		function fn_pop(){
			...
			window.parent.NrvPub.AjaxPopup('/MF/EPMF01401882.do', pagedata);
		}
