...
<script type="text/javaScript" language="javascript" defer="defer" >
		...
		function fn_upd(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF4763601.do";
			kora.common.goPage('/MF/EPMF4763642.do', INQ_PARAMS);
		}
	...
	function fn_reg(){
		...
		INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF4763601.do";
		kora.common.goPage('/MF/EPMF4763631.do', INQ_PARAMS);
	}
