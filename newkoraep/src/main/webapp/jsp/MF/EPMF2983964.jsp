...
<script type="text/javaScript" language="javascript" defer="defer">
  ...
  /*   //조정확인 후 상세조회 다시 조회
	...
	function fn_upd3_check(){
		...
		confirm("선택된 입고확인 내역에 대해 취소요청을 진행합니다. \n\n 취소 처리된 입고확인 내역은 반환등록 상태로 변환되며 복원되지 않습니다. 계속 진행하시겠습니까?","fn_upd3");
	}
   
   //확인취소요청 상태변경
	function fn_upd3(){
			var url 		= "/MF/EPMF2983901_21.do"
			var input 	= {"list": ""};
			var item		={};
			var row 		= new Array();
     ...
     //목록
  	function fn_page(){
  		console.log(JSON.stringify(INQ_PARAMS.PARAMS));
	...
	function link(){
		...
		window.parent.NrvPub.AjaxPopup('/MF/EPMF29839883.do', pagedata);
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="PRPS_CD"  	headerText="'+ parent.fn_text('prps_cd')+ '" width="8%" 	textAlign="center"  />');		//용도(유흥용/가정용)
			...
			layoutStr2.push('			<DataGridColumn dataField="PRPS_NM"  	 headerText="'+ parent.fn_text('prps_cd')+ '"			width="130"		 textAlign="center"/>');											//용도(유흥용/가정용)
