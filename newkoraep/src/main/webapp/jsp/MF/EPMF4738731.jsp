...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    function fn_prps_cd(){
		...
		if( null != $("#PRPS_CD").val() && $("#PRPS_CD").val() !=""){
			...
			input["WRHS_CFM_DT"] 	= cfm_gridList[0].WRHS_CFM_DT	//반화일자
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	function fn_reg(){
        ...
        */		
	 	...
	 	data["list_ori"] = JSON.stringify(cfm_gridList);
  ...
  //선택한 행 입력창에 값 넣기
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('				<DataGridColumn dataField="CFM_WHSL_FEE_STAX"   	headerText="'+ parent.fn_text('whsl_stax2')+ '"	width="150" 	formatter="{numfmt}" 	textAlign="right"  id="num7"/>');	//도매부가세
			...
			layoutStr.push('				<DataGridFooterColumn summaryOperation="SUM" dataColumn="{num7}" formatter="{numfmt1}" textAlign="right"/>');	//도매부가세
			layoutStr.push('				<DataGridFooterColumn summaryOperation="SUM" dataColumn="{num8}" formatter="{numfmt}" textAlign="right"/>');	//소매수수료
			...
			layoutStr2.push('				<DataGridColumn dataField="CRCT_WHSL_FEE_STAX"	headerText="'+ parent.fn_text('whsl_stax2')+ '"	width="150" 	formatter="{numfmt}" 	textAlign="right"  id="num7"  />');//도매부가세
