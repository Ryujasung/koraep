...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			kora.common.setEtcCmBx2(bizrNmList, "", "", $("#REQ_MFC_BIZR"), "BIZRID_NO", "BIZRNM", "N");
			kora.common.setEtcCmBx2(bizrNmList_all, "", "", $("#CFM_MFC_BIZR"), "BIZRID_NO", "BIZRNM", "N", "S");
			...
			fn_bizrTpCd($("#REQ_MFC_BIZR"), $("#REQ_MFC_BRCH"));
			fn_ctnrCd($("#REQ_MFC_BIZR"), $("#REQ_CTNR_CD"));
			 ...
			 ***********************************/
			 $("#CFM_MFC_BIZR").change(function(){
				 fn_bizrTpCd($(this), $("#CFM_MFC_BRCH"), "Y");
		...
		function fn_bizrTpCd(obj, tt, allYn){
		    ...
		    input["STAT_CD"] = "Y";
       	    ...
       	    ajaxPost(url, input, function(rtnData) {
   				if (null != rtnData) {   
   					kora.common.setEtcCmBx2(rtnData, "","", tt, "BRCH_ID_NO", "BRCH_NM", "N" ,'E');
   				} else {
   					alertMsg("error");
   				}
    		}, false);
