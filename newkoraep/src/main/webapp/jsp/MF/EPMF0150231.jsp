...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(function(){
        ...
        var mfc_bizrnmList  = jsonObject($('#mfc_bizrnmList').val());
        var area_cd_list        = jsonObject($('#area_cd_list').val());
        kora.common.setEtcCmBx2(mfc_bizrnmList, "","", $("#BIZRNM"), "BIZRID_NO", "BIZRNM", "N" ,'S');          //생산자
        ...
        $('[name=GRP_YN]').change(function() { 
            ...
            if($("input:radio[name='GRP_YN']:checked").val() == 'N'){
                ...
                if($('#BIZRNM').val() == ''){
                    ...
                    alertMsg("먼저 생산자를 선택하세요.");
                    return;
                }
                
                var url = "/MF/EPMF0150231_19.do" 
                var input ={};
        ...
        $(":radio[name='GRP_YN'][value='N']").prop("checked", true);
        $('[name=GRP_YN]').trigger('change');
...
//                  } 
    ...
    function fn_reg(){
        ...
        if($('#BRCH_NO').val() == '9999999999' && $("input:radio[name='GRP_YN']:checked").val() == 'N'){
            alert('해당 직매장/공장 코드는 총괄직매장으로만 등록 가능합니다.');
            return;
        }
    ...
    function fn_bizrnm_change() {
        ...
        if(bizrNm.length >= 2) {
            console.log(bizrNm.substring(0,2));
            if("M1" == bizrNm.substring(0,2)) {
                ...
                <div class="write_tbl">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <select id="BIZRNM" name="BIZRNM" style="width: 210px" class="i_notnull" alt="생산자"></select>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="row" >
                                    <label class="rdo"><input type="radio" id="GRP_YN" name="GRP_YN" value="Y" checked="checked"><span>총괄직매장</span></label>
                        ...
                        <tr class="grpM1">
                            ...
                            <td>
                                <div class="row">
                                    <input type="text" id="BRCH_NO" name="BRCH_NO" style="width: 330px;" class="i_notnull" alt="직매장/공장코드" maxlength="10" format="engNum">
                                </div>
                            </td>
                        </tr>
                        <tr class="grpM2"  style="display:none">
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <input type="hidden" name="BRCH_BIZRNO" id="BRCH_BIZRNO" value="" />
                                </div>
                            </td>
                        </tr>
                        <tr>
