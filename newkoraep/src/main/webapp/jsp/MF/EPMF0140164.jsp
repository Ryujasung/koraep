...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_pop(){
			...
			window.parent.NrvPub.AjaxPopup('/MF/EPMF0140188.do', pagedata);
		}
		...
		function fn_upd3(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF0140164.do";
			kora.common.goPage('/MF/EPMF0140142.do', INQ_PARAMS);
		}
