...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			brchList = jsonObject($('#brchList').val());;	
			deptList = jsonObject($('#deptList').val());;	
			...
			//작성체크용
			$('#BRCH_CD').attr('alt', parent.fn_text('brch'));
			...
			if(searchDtl.BIZR_TP_CD == 'T1'){
				kora.common.setEtcCmBx2(brchList, "", "", $("#BRCH_CD"), "ETC_CD", "ETC_CD_NM", "N", "S");
			}else{
				kora.common.setEtcCmBx2(brchList, "", "", $("#BRCH_CD"), "BRCH_ID_NO", "BRCH_NM", "N", "S");
			}
			
			kora.common.setEtcCmBx2(deptList, "", "", $("#DEPT_CD"), "DEPT_CD", "DEPT_NM", "N", "S");
		...
		function fn_reg_exec(){
			...
			sData["MBIL_NO1"] = $("#MBIL_NO1").val();
			
		 	var url = "/MF/EPMF0140142_21.do";
		...
		/**
		 ...
		 function fnSetDtlData(data){
			...
			$("#BIZRNO").text(kora.common.null2void(data.BIZRNO_DE));
			
			if(data.BIZR_TP_CD == 'T1'){ //센터
				$("#BRCH_CD").val(kora.common.null2void(data.CET_BRCH_CD));
			}else{
				$("#BRCH_CD").val(kora.common.null2void(data.BRCH_ID+";"+data.BRCH_NO));
			}
            ...
            userSeCd = kora.common.null2void(data.USER_SE_CD,"S");
            
            if("D" == userSeCd) {
                $('#phoneCertifiedDiv').attr('style', ' ');
                $("#USER_NM").attr("readonly","readonly");
                $("#MBIL_NO1").attr("disabled",true);
                $("#MBIL_NO2").attr("readonly","readonly");
                $("#MBIL_NO3").attr("readonly","readonly");
            }
		}
...
<input type="hidden" id="deptList" value="<c:out value='${deptList}' />"/>
				...
				<form name="frmMenu" id="frmMenu" method="post" >
					...
					<table>
						...
						<tr>
							...
							<td>
								<div class="row">
									<select id="BRCH_CD" name="BRCH_CD" style="width: 179px;" class="i_notnull"></select>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="row">
									<select id="DEPT_CD" name="DEPT_CD" style="width: 179px;"></select>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="row">
									<input type="text" id="USER_NM" name="USER_NM" style="width: 179px;" class="i_notnull" maxByteLength="60">
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<div class="row">
									...
									<input type="text" id="TEL_NO2" name="TEL_NO2" style="width:70px" maxlength="4" format="number">
									<div class="sign"> - </div>
									<input type="text" id="TEL_NO3" name="TEL_NO3" style="width:70px" maxlength="4" format="number">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="row">
                                    ...
                                    <div id="phoneCertifiedDiv" style="display:none">
                                    <button  class="btn34 c6" style="width: 120px;" type="button" onclick="fn_phoneCert()">휴대폰 인증</button>
