	...
	function fn_reg(){
		...
		var collection = gridRoot2.getCollection();
				...
				//반환상태가 다른놈일경우		
			 	...
			 	//console.log(cfm_qty+";"+dmgb_qty+";"+vrsb_qty+";;"+rtn_qty_tot);
  ...
  //선택한 행 입력창에 값 넣기
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr2.push('	<DataGrid headerColors="[#EFF6FC,#EFF6FC]" verticalAlign="middle" id="dg2" headerWordWrap="true" horizontalScrollPolicy="on"  headerHeight="35">');
