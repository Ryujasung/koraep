...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="PRPS_NM" headerText="'+ parent.fn_text('prps_cd')+ '" width="150" />');
			...
			layoutStr.push('			<DataGridColumn dataField="DLIVY_QTY" headerText="'+ parent.fn_text('dlivy_qty')+ '" width="130" textAlign="right" formatter="{numfmt}" id="sum" />');
			layoutStr.push('			<DataGridColumn dataField="DLIVY_GTN" headerText="'+ parent.fn_text('gtn')+ '" width="130" textAlign="right" formatter="{numfmt}" id="sum2" />');
			...
			layoutStr.push('				<DataGridFooterColumn/>');
			layoutStr.push('				<DataGridFooterColumn/>');
			layoutStr.push('				<DataGridFooterColumn labelJsFunction="totalsum1" dataColumn="{sum}" formatter="{numfmt}" textAlign="right"/>');
