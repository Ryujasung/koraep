    ...
    $(function() {
     ...
     function fn_init(){
    	 kora.common.setEtcCmBx2(dtList, "","", $("#SEARCH_GBN"), "ETC_CD", "ETC_CD_NM", "N");//조회기간 선택
   	 	 ...
   	 	 kora.common.setEtcCmBx2(brch_nmList, "","", $("#MFC_BRCH_NM"), "BRCH_ID_NO", "BRCH_NM", "N" ,'T');//직매장
     ...
     //생산자 변경시 생산자랑 거래중인 도매업자 조회  ,빈용기명 , 직매장 
     function fn_mfc_bizrnm(){
  			var url = "/MF/EPMF6139401_19.do" 
  			var input = {};
   ...
   function fn_mfc_brch_nm(){
	   var url = "/MF/EPMF6139401_193.do" 
			var input ={};
		    	arr	=[];
		    	arr = $("#MFC_BIZRNM").val().split(";");
			 	input["MFC_BIZRID"] = arr[0];//생산자아이디  
				input["MFC_BIZRNO"] = arr[1];//생산자사업자번호
				
			if( $("#MFC_BRCH_NM").val() !="" ){ //직매장 
					arr3	=[];
			    	arr3 	=$("#MFC_BRCH_NM").val().split(";");
    				input["MFC_BRCH_ID"]		= arr3[0];
    				input["MFC_BRCH_NO"]	= arr3[1];
		    }
			 if($("#WHSL_SE_CD").val() !=""){
    		 input["BIZR_TP_CD"]	=$("#WHSL_SE_CD").val();
  			 }
...
/****************************************** 그리드 셋팅 끝***************************************** */
	...
	layoutStrChart.push('             <Column3DSeries labelPosition="outside" yField="CRCT_GTN_TOT" displayName="보증금" outsideLabelYOffset="-10" showValueLabels="[]"  showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                  <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
	layoutStrChart.push('            <Column3DSeries labelPosition="outside" yField="CRCT_FEE_TOT" displayName="수수료" outsideLabelYOffset="-10"  showValueLabels="[]" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
	layoutStrChart.push('            <Column3DSeries labelPosition="outside" yField="CRCT_FEE_STAX_TOT" displayName="부가세" outsideLabelYOffset="-10"  showValueLabels="[]"  showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                  <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
    ...
    <div class="iframe_inner" >
		...
		<section class="secwrap"   id="params">
				<div class="srcharea" > 
					...
					<div class="row">
						...
						<div class="col" style="width: 25%">
							...
							<div class="box"  >
								<select id="MFC_BRCH_NM" style="width: 179px" class="i_notnull" ></select>
							</div>
						</div>
						<div class="col" >
				...
				<div class="boxarea" style="width:25%;margin:0px;">
					<div class="info_tbl" style="">
						<table>
							...
							<thead>
								<tr>
									<th colspan="2" class="b">빈용기 보증금 취급수수료 합계</th>
								</tr>
							</thead>
							<tbody>
								<tr>
			...
			<div class="boxarea mt10">  <!-- 634 -->
				<div id="gridHolder" style="height: 585px; background: #FFF;"></div>
