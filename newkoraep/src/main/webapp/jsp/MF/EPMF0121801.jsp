	...
	<script type="text/javaScript" language="javascript" defer="defer">
	  ...
	  //취급정보 삭제
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF0121801.do";
			kora.common.goPage('/MF/EPMF0121831.do', INQ_PARAMS);
		}
		/**
		 * 등록팝업 이동
		 */
...
// 			parent_item =input;
		...
		function fn_pop(){
			...
			window.parent.NrvPub.AjaxPopup('/MF/EPMF0121888.do', pagedata);
		}
