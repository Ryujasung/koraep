...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(function() {
		...
		kora.common.setEtcCmBx2(mfc_bizrnmList, "","", $("#MFC_BIZRNM"), "BIZRID_NO", "BIZRNM", "N");	
// 		fn_mfc_bizrnm();
...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="DRCT_RTRVL_DT" headerText="'+parent.fn_text('drct_rtrvl_dt')+'" width="100" formatter="{datefmt}"/>');
			...
			layoutStr.push('			<DataGridColumn dataField="CUST_BIZRNM"	headerText="'+ parent.fn_text('cust2')+ '" width="150" />');
			layoutStr.push('			<DataGridColumn dataField="CUST_BIZRNO" headerText="'+ parent.fn_text('cust_bizrno')+ '" width="150" formatter="{maskfmt}" />');
			...
			layoutStr.push('			<DataGridColumn dataField="DRCT_RTRVL_QTY" headerText="'+ parent.fn_text('drct_rtrvl_qty')+ '" width="130" textAlign="right" formatter="{numfmt}" id="sum1" />');
			...
			layoutStr.push('			<DataGridColumn dataField="DRCT_PAY_FEE" headerText="'+ parent.fn_text('drct_pay_fee')+ '" width="140" textAlign="right" formatter="{numfmt}" id="sum3" />');
			layoutStr.push('			<DataGridColumn dataField="DRCT_RTRVL_STAT_NM" headerText="'+ parent.fn_text('stat')+'" width="100" id="tmp1" />');
			layoutStr.push('			<DataGridColumn dataField="DRCT_RTRVL_REG_DT" headerText="'+parent.fn_text('drct_rtrvl_reg_dt')+'" width="110" formatter="{datefmt}" id="tmp2" />');
			layoutStr.push('		</groupedColumns>');
