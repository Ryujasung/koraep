...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(function() {
     ...
     function fn_whsl_se_cd(){
    	   var url = "/MF/EPMF47056642_193.do" 
		   var input ={};
		   if($("#BIZR_TP_CD").val() !=""){
   ...
   function fn_mfc_brch_nm(){
		 var url = "/MF/EPMF47056642_192.do" 
		 var input ={};
		 arr2	= [];
   ...
   //입고내역선택 조회
    function fn_sel(){
		 ...
		 var input	= {};
		 var url = "/MF/EPMF47056642_194.do" 
	...
	function fn_reg() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF47056642.do";
		kora.common.goPage('/MF/EPMF4705631.do', INQ_PARAMS);
	}
	...
	function dtl_link(data){
		...
		if(data == '2'){
			url = "/MF/EPMF4738764.do";	 //수기입고정정내역조회
		}
		//파라미터에 조회조건값 저장 
		INQ_PARAMS["PARAMS"] = {};
		INQ_PARAMS["PARAMS"] = input;
