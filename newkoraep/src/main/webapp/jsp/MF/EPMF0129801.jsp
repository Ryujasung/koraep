...
<script src="/js/kora/paging_common.js"></script>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF0129801.do";
			kora.common.goPage('/MF/EPMF0129831.do', INQ_PARAMS);
		}
		...
		function fn_upd(){
			...
			INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
			INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF0129801.do";
			kora.common.goPage('/MF/EPMF0129842.do', INQ_PARAMS);
		}
