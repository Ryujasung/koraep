...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(function() {
     ...
     function fn_whsl_se_cd(){
    	   var url = "/MF/EPMF47387642_193.do" 
		   var input ={};
		   if($("#BIZR_TP_CD").val() !=""){
   ...
   function fn_mfc_brch_nm(){
		 var url = "/MF/EPMF47387642_192.do" 
		 var input ={};
		 arr2	= [];
   ...
   //입고내역선택 조회
    function fn_sel(){
		 ...
		 var input	={};
		 var url = "/MF/EPMF47387642_194.do" 
		 var start_dt 			= $("#START_DT").val();
		 var end_dt    			= $("#END_DT").val();
	...
	function fn_reg() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF47387642.do";
		kora.common.goPage('/MF/EPMF4738731.do', INQ_PARAMS);
	}
