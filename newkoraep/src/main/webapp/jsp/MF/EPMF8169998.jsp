...
$(document).ready(function(){
	...
	if(askInfo.length != undefined){
		$("#sbj").val(askInfo[0].SBJ);
		$("#BBS_TEXT").text(askInfo[0].CNTN);
		$("#FAQ_SEQ").val(askInfo[0].FAQ_SEQ);
		if(fileList.length != 0){
			for(var i=0;i<fileList.length;i++){
				$("#fileList").append("<li id=il_"+fileList[i].REG_SN+">"+fileList[i].FILE_NM+"<a href='javascript:fn_atch_file_del("+fileList[i].REG_SN+")' class='delete'><img src='/images/util/flie_close.png' alt='삭제'></a></li>");
				regSn++;
			}
		}
	}
	...
	$("#btn_lst2").click(function(){
		location.href =   "/MF/EPMF8169901.do";
	});
...
fileNameOnChange = function(obj) {
	...
	<div class="iframe_inner">
		...
		<form name="fileForm" id="fileForm" method="post" enctype="multipart/form-data" action="/MF/EPMF8169998_09.do">
