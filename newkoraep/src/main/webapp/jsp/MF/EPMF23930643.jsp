...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   //인쇄
	...
	function fn_page2(){
		...
		INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF23930643.do";
	...
	function fn_page3(){
		...
		INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF23930643.do";
		kora.common.goPage('/MF/EPMF23930642.do', INQ_PARAMS);
	}
	...
	function fn_page4(){
		...
		INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/MF/EPMF23930643.do";
		kora.common.goPage('/MF/EPMF66452642.do', INQ_PARAMS);
	}
