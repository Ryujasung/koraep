	...
	<script type="text/javaScript" language="javascript" defer="defer">
		 ...
		 */
		 function fn_set_grid() {
		     ...
		     layoutStr.push('   <DataGridColumn dataField="RTN_REG_DT"  headerText="'+parent.fn_text('rtn_reg_dt')+'" width="150" />');
		     layoutStr.push('   <DataGridColumn dataField="RTN_DT"  headerText="'+parent.fn_text('rtrvl_dt')+'" width="150" />');
			 layoutStr.push('	<DataGridColumn dataField="WRHS_CFM_DT"  headerText="'+parent.fn_text('wrhs_cfm_dt')+'" width="150" formatter="{dateFmt}" />');
