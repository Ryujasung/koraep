...
<script type="text/javaScript" language="javascript" defer="defer">
     ...
     $(function() {
    	...
    	dps_fee_list 				= jsonObject($("#dps_fee_list").val());		
     ...
     function fn_init(){
			...
			kora.common.setEtcCmBx2(whsdl_cd_list, "","", $("#WHSDL_BIZRNM"), "WHSDL_BIZRID_NO", "WHSDL_BIZRNM", "N" ,'S');	//도매업자
	...
	function fn_reg(){
		...
		if($("#WHSDL_BIZRNM").val() =="" ){
			...
			return;
		}else if(!kora.common.fn_validDate_ck( "R", $("#RTRVL_DT").val())){ //등록일자제한 체크
			return;
		}
		var nChk = 0;
		var validch=0;
		$("#RTRVL_CTNR_CD_LIST").find(".inqChk").each(function(){
			...
			if(kora.common.null2void($(this).val()) != "" &&kora.common.null2void($(this).val()) != "0" ){
				...
				input["WHSDL_BRCH_ID"] 		= arr[2];
				input["WHSDL_BRCH_NO"] 	= arr[3];
...
<body>
    <div class="iframe_inner"  >
			...
			<input type="hidden" id="dps_fee_list" value="<c:out value='${dps_fee_list}' />" />
							...
							<div class="write_tbl">
								...
								<tbody>
									 ...
									 <tr>
											...
											<td>
												<div class="row">
														<select id="WHSDL_BIZRNM" style="width: 90%" "></select>
												</div>
											</td>
			...
			<section class="secwrap mt20" style='width:80%'>
					 <div class="write_area">
							<div class="write_tbl">
								<table>
									<colgroup>
