...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   //변경 페이지 이동 
  	function fn_upd() {
 		...
 		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE2910101.do";
   ...
   function fn_del(){
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
		...
		layoutStr.push('			<DataGridColumn dataField="RTN_WHSL_FEE_STAX_TOT" headerText="'+ parent.fn_text('stax')+ '" width="80" formatter="{numfmt}" id="num7"  textAlign="right" />');//부가세
		...
		layoutStr.push('			<DataGridColumn dataField="REAL_PAY_DT" headerText="'+parent.fn_text('real_pay_dt')+'" width="140" id="tmp4" textAlign="center"/>');
