  ...
  /*   //조정확인 후 상세조회 다시 조회
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('				<DataGridColumn dataField="RTN_WHSL_FEE_STAX"  	headerText="'+ parent.fn_text('stax')+ '" 	width="6.5%" 	formatter="{numfmt1}" 	textAlign="right"   id="num5"  />');	//도매부가세
			layoutStr.push('			</DataGridColumnGroup>');
			...
			layoutStr.push('				<DataGridFooterColumn summaryOperation="SUM" dataColumn="{num5}" formatter="{numfmt1}" textAlign="right"/>');	//부가세
			...
			layoutStr2.push('			<DataGridColumn dataField="RTN_QTY"  	 headerText="'+ parent.fn_text('rtn_qty')+'"			width="80" 	 textAlign="right" id="num1" formatter="{numfmt}" />');								//반환량
			...
			layoutStr2.push('				<DataGridColumn dataField="CFM_WHSL_FEE_STAX"	headerText="'+ parent.fn_text('stax')+ '"	width="90" 	formatter="{numfmt1}" textAlign="right"  id="num7"/>');	//부가세
			layoutStr2.push('			</DataGridColumnGroup>');
			...
			layoutStr2.push('				<DataGridFooterColumn summaryOperation="SUM" dataColumn="{num7}" formatter="{numfmt1}" textAlign="right"/>');	//부가세
