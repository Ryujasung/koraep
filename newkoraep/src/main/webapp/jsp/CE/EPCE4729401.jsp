...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			//교환정산기간 추가
			$("#EXCA_STD_CD").append("<option value='C'>교환정산</option>");
		    $("#EXCA_STD_CD").append("<option value='M'>수기정산</option>");
			...
			*/
			...
			for(var i=0; i<jData1.length; i++){
                ...
                if(tmpBizrNo != jData1[i].BIZRNO){
                    alertMsg("생산자정보가 동일한 정산서만 선택 가능합니다.");
                    return false;
                }
			...
			for(var i=0; i<jData1.length; i++){
				...
				itmBill["STD_YEAR"] = jData1[i].STD_YEAR;
				...
				itmBill["YEAR_CHG_YN"] = jData1[i].YEAR_CHG_YN;
			...
			for(var i=0; i<jData2.length; i++){
				...
				itmAcp["BANK_CD"] = jData2[i].BANK_CD;
				itmAcp["ACCT_NO"] = jData2[i].ACCT_NO;
				itmAcp["ACCT_TXDAY"] = jData2[i].ACCT_TXDAY;
				itmAcp["ACCT_TXDAY_SEQ"] = jData2[i].ACCT_TXDAY_SEQ;

				arrAcp.push(itmAcp); //계좌수납내역 데이터 처리용
			}
		 ...
		 */
		 function fn_set_grid() {
			 ...
			 layoutStr.push('	<DataGridColumn dataField="BIZRNM"  headerText="'+parent.fn_text('mfc_bizrnm')+'" width="23%"/>');
			 layoutStr.push('	<DataGridColumn dataField="EXCA_REG_DT"  headerText="'+parent.fn_text('exca_issu_dt')+'" width="23%" formatter="{datefmt}"/>');
			 layoutStr.push('	<DataGridColumn dataField="EXCA_ISSU_SE_NM"  headerText="'+parent.fn_text('se')+'" width="23%"/>');
		 ...
		 /**
			 ...
			 */
			 function fn_set_grid3() {
				 ...
				 layoutStr3.push('	<DataGridColumn dataField="BIZRNM"  headerText="'+parent.fn_text('mfc_bizrnm')+'" width="20%" />');
				...
				<div class="srcharea"  id="divInput1">
					...
					<div class="row">
						<div class="col">
							...
							<div class="box">
								<select id="MFC_BIZR" name="MFC_BIZR" style="width: 179px" >
					            </select>
							</div>
						</div>
						<div class="btn" id="UL">
