...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(document).ready(function(){
        ...
        $('#RPST_MBIL_NO1').attr('alt', parent.fn_text('mbil_tel_no'));
        $('#RPST_MBIL_NO2').attr('alt', parent.fn_text('mbil_tel_no'));
        $('#RPST_MBIL_NO3').attr('alt', parent.fn_text('mbil_tel_no'));
        
        $('#ASTN_EMAIL_TXT').attr('alt', parent.fn_text('email'));
        $('#ASTN_DOMAIN_TXT').attr('alt', parent.fn_text('email'));
        $('#ErpCdList_SEL').attr('alt', parent.fn_text('erp_cd_nm'));
    	/**
		 * ERP코드 변경 이벤트
		 */
		$("#ErpCdList_SEL").change(function(){
    ...
    function fn_reg(){
        if(searchDtl.BIZR_SE_CD == 'S'){
            ...
            */
			...
			if($("#BIZRNM").val() == null || $("#BIZRNM").val() == ""){
				alertMsg($("#BIZRNM").attr("alt")+" 을(를) 확인하세요.");
				$("#BIZRNM").focus();
    ...
    function fnSetDtlData(data){
        ...
        if(data.BIZR_TP_CD == 'W1' || data.BIZR_TP_CD == 'W2'){
            $('.erpCd').each(function(){
                $(this).attr('style', '');
            });
        }
        ...
        if(data.BIZR_TP_CD == 'W2' || data.BIZR_TP_CD == 'M1' || data.BIZR_TP_CD == 'M2'){
            $('.bizrTpCdW2').attr('style', '');
        }else{
            $('.bizrTpCdW2').attr('style', 'display:none');
        }
        ...
        kora.common.setEtcCmBx2(ErpCdList, "", "", $("#ErpCdList_SEL"), "ETC_CD", "ETC_CD_NM", "N", "S");
        ...
        $("#ErpCdList_SEL").val(kora.common.null2void(data.ERP_CD));
        ...
        if (data.ERP_CD == "E99") {
			$("#ERP_CD_NM").attr("disabled",false);
			$("#ERP_CD_NM").addClass("i_notnull");
        	$("#ERP_CD_NM").val(kora.common.null2void(data.ERP_CD_NM));
        }
        ...
        $('#RPST_MBIL_NO1').val(kora.common.null2void(data.RPST_MBIL_NO1));
        $('#RPST_MBIL_NO2').val(kora.common.null2void(data.RPST_MBIL_NO2));
        $('#RPST_MBIL_NO3').val(kora.common.null2void(data.RPST_MBIL_NO3));
        ...
        //$("#CTRT_FILE_NM").val(kora.common.null2void(data.CTRT_FILE_NM));
...
<!-- 									<div class="emp">활동 / 비활동 / 수기 / (지급지점)</div> -->
					...
					<tr>
						...
						<td>
							<div class="row">
								<input type="text" id="BIZRNM" name="BIZRNM" style="width: 330px;" class='i_notnull' maxByteLength="90"/>
					...
					<tr>
					 ...
					 -->
					<tr>
						<th rowspan="3" id="tel_no" name="tel_no">전화번호</th>
					...
					<tr>
						<th class="bd_l" id="rpst_mbil_no" name="rpst_mbil_no">대표 휴대폰번호<span class="red">*</span></th>
						<td>
							<div class="row">
								<select id="RPST_MBIL_NO1" name="RPST_MBIL_NO1" style="width:80px" class="i_notnull">
									<option id="cho3" value=""></option>
								</select>
								<div class="dash">-</div>
								<input type="text" id="RPST_MBIL_NO2" name="RPST_MBIL_NO2" style="width: 100px;">
								<div class="dash">-</div>
								<input type="text" id="RPST_MBIL_NO3" name="RPST_MBIL_NO3" style="width: 100px;">
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<div class="row" style="padding:5px 0 5px 20px">
								...
								<input type="text" id="ADDR2" name="ADDR2" style="width: 330px; margin-left: 5px !important;" placeholder="상세주소입력" class="i_notnull" alt="사업장주소">
							</div>
						</td>
					</tr>
					<tr>
...
<!-- 										<label class="btn34 c6" style="width: 92px;"><input type="file" id="FILE_NM" onchange="fn_fileCheck(this.value, '1');">파일첨부</label> -->
					...
					<tr class="bizrTpCdW2" style="display:none">
...
<!-- 										<label class="btn34 c6" style="width: 92px;"><input type="file" id="CTRT_FILE_NM" onchange="fn_fileCheck(this.value, '2');">파일첨부</label> -->
					...
					<tr class="erpCd" style="display:none">>
                        <th colspan="2">ERP구분<span class="red">*</span></th>
                        <td>
                            <div class="row">
                                <select id="ErpCdList_SEL" name="ErpCdList_SEL" style="width: 200px;" class="i_notnull">
                                </select>
