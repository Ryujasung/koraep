...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   function fn_rtrvl_dt(){
	...
	function fn_dataSet(item){
		var input	={};
		var url 	 	= "/CE/EPCE2925831_192.do"; // 수수료조회
		dps_fee_list=[];
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="RTRVL_STAT_CD"		visible="false" />');
			layoutStr.push('			<DataGridColumn dataField="WHSDL_BRCH_NM_CD"	visible="false" />');
				...
				<div class="srcharea"  id="divInput" > 
						...
						<div class="row">
								<div class="col">
									...
									<div class="box">
										<input type="text" id="RTRVL_QTY" style="width: 179px"  format="minus"   class="i_notnull"  maxlength="8"/>
									</div>
								</div>
								<div class="col" style="">
									<div class="tit" id="rtl_fee2_txt"></div>  <!-- 소매수수료 -->
									<div class="box" style="" >
										<input type="text" id="REG_RTRVL_FEE" style="width: 179px" format="minus"   class="i_notnull"  />
									</div>
								</div>   
								<div class="col">
