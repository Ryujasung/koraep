...
function fn_setLnb(list){
	...
	lnbTxt.push('<li><a href="/CE/EPCE5580901.do" id="' + lnbGrpCd + '">마이메뉴관리</a></li>');
	lnbTxt.push('<li><a href="/CE/EPCE5599001.do" id="' + lnbGrpCd + '">본인정보조회</a></li>');
