...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="CRCT_DLIVY_QTY" 	headerText="'+ parent.fn_text('crct_dlivy_qty')+ '" 	width="140" 	textAlign="right"    formatter="{numfmt}" id="sum2" />');
			layoutStr.push('			<DataGridColumn dataField="EXCA_DLIVY_QTY" 	headerText="'+ parent.fn_text('exca_dlivy_qty')+ '" width="140" 	textAlign="right"    formatter="{numfmt}" id="sum3" />');
					...
					<div class="row">
						<div class="col" style="">
							...
							<div class="box">
								...
								<div data-ax5autocomplete="autocomplete" data-ax5autocomplete-config="{multiple: true}" style="max-width :600px; z-index: 0;"  id="data-ax5autocomplete_M" ></div>
							</div>
						</div>
					</div> <!-- end of row -->
					<div class="row">
							<div class="col">
								...
								<div class="box">
									<!-- <select id="WHSDL_BIZRNM" name="WHSDL_BIZRNM" style="width: 179px"></select> -->
									 <div data-ax5autocomplete="autocomplete" data-ax5autocomplete-config="{multiple: true}" style="max-width :600px; z-index: 0;" id="data-ax5autocomplete_W" ></div> 
								</div>
							</div>
