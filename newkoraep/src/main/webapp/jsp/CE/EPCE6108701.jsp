...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('<rMateGrid>');
			 ...
			 layoutStr.push('<DataGrid headerColors="[#EFF6FC,#EFF6FC]" verticalAlign="middle" id="dg1" headerHeight="35" horizontalScrollPolicy="on" draggableColumns="true" sortableColumns="true" textAlign="center" >');
			 ...
			 layoutStr.push('	<DataGridColumn dataField="REQ_MFC_BIZRNM"  headerText="'+parent.fn_text('reg_mfc')+'" width="150"/>');
			 layoutStr.push('	<DataGridColumn dataField="REQ_MFC_BRCH_NM"  headerText="'+parent.fn_text('reg_mfc_brch')+'" width="150"/>');
			 layoutStr.push('	<DataGridColumn dataField="CFM_MFC_BIZRNM"  headerText="'+parent.fn_text('cfm_mfc')+'" width="150"/>');
			 layoutStr.push('	<DataGridColumn dataField="CFM_MFC_BRCH_NM"  headerText="'+parent.fn_text('cfm_mfc_brch')+'" width="150"/>');
			 ...
			 layoutStr.push('	<DataGridColumn dataField="EXCH_GTN" id="exchGtnTot"  headerText="'+parent.fn_text('amt')+'" width="120" formatter="{numfmt}" textAlign="right"/>');
			 layoutStr.push('	<DataGridColumn dataField="REQ_CTNR_NM" id="tmp1" headerText="'+parent.fn_text('reg_ctnr_nm')+'" width="220"/>');
			 layoutStr.push('	<DataGridColumn dataField="CFM_CTNR_NM" id="tmp2" headerText="'+parent.fn_text('exch_ctnr_nm')+'" width="220"/>');
             layoutStr.push('   <DataGridColumn dataField="REQ_ALKND_NM" id="tmp6" headerText="요청'+ parent.fn_text('alknd_cd')+ '" width="130" />');
             layoutStr.push('   <DataGridColumn dataField="CFM_ALKND_NM" id="tmp7" headerText="확인'+ parent.fn_text('alknd_cd')+ '" width="130" />');
             layoutStr.push('   <DataGridColumn dataField="REQ_STANDARD_NM"     headerText="요청용기구분"        width="100" textAlign="center"  />');
             layoutStr.push('   <DataGridColumn dataField="CFM_STANDARD_NM"     headerText="확인용기구분"        width="100" textAlign="center"  />');
			 layoutStr.push('	<DataGridColumn dataField="EXCH_CFM_DT" id="tmp3" headerText="'+parent.fn_text('exch_cfm_dt')+'" width="100" formatter="{dateFmt}"/>'); 
			 layoutStr.push('	<DataGridColumn dataField="EXCH_REQ_CRCT_STAT_NM" id="tmp4" headerText="'+parent.fn_text('exch_reg_mfc_stat')+'" width="150"/>');
			 layoutStr.push('	<DataGridColumn dataField="EXCH_CFM_CRCT_STAT_NM" id="tmp5" headerText="'+parent.fn_text('exch_cfm_mfc_stat')+'" width="150"/>');
			 layoutStr.push('</groupedColumns>');
	...
	function totalsum1(column, data) {
		if(sumData) 
			return sumData.EXCH_QTY; 
		else 
			return 0;
	}
	function totalsum2(column, data) {
		if(sumData) 
			return sumData.EXCH_GTN; 
		else 
			return 0;
	}
	/* 총합계 추가 */
