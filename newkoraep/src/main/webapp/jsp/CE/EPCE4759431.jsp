...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			//도매업자
			kora.common.setEtcCmBx2([], "","", $("#WHSDL"), "CUST_BIZRID_NO", "CUST_BIZRNM", "N" ,'S');
	    	...
	    	var err_msg2 = "";
	    	 ...
	    	 var mfc_bizrno = mfc_bizr_val[1];
	     	 ...
	     	 for(var i=0; i<rtnData.length ;i++) {
	     		...
	     		input["DLIVY_SE_NM"]		= rtnData[i].출고구분
...
<body>
    <div class="iframe_inner" id="testee" >
    		...
    		<input type="hidden" id="dlivy_stat_se" value="<c:out value='${dlivyStatSeList}' />" />
