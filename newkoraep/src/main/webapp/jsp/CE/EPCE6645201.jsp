	     ...
	     function fn_upd(){
	    	 ...
	    	 var chkLst = selectorColumn.getSelectedItems();
				...
				INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		 		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6645201.do";
	
		 		kora.common.goPage('/CE/EPCE6645242.do', INQ_PARAMS);
	     }
...
// 			hideLoadingBar();
	...
	function fn_reg(){
		INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6645201.do";
		kora.common.goPage('/CE/EPCE6645231.do', INQ_PARAMS);
	}
...
/****************************************** 그리드 셋팅 시작***************************************** */
	...
	//상세조회 링크
	 function link() {
		...
		INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6645201.do";
		kora.common.goPage('/CE/EPCE6645264.do', INQ_PARAMS);
	}
