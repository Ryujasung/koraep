 			...
 			input["DRCT_RTRVL_DT"] 	= $("#RTL_RTN_DT").val(); 		//소매직접반환일자
       	    ...
       	    ajaxPost(url, input, function(rtnData) {
   				if ("" != rtnData && null != rtnData) {   
   					 ...
   					 kora.common.setEtcCmBx2(rtnData.brch_dtssList, "","", $("#MFC_BRCH_NM"), "BRCH_ID_NO", "BRCH_NM", "N" ,'S');//소매직접반환대상 직매장/공장		
