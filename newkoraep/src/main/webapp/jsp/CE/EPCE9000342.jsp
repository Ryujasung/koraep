...
<script type="text/javaScript" language="javascript" defer="defer">
     ...
     $(function() {
		...
		//text 셋팅
		$('#title_sub').text('<c:out value="반환수집소내역변경" />');						  //타이틀
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	function fn_reg2(){
		...
		*/
		...
		/* input["RTRVL_DT"] =INQ_PARAMS.RTRVL_DT;
		input["RCS_NM"] =INQ_PARAMS.RCS_NM;
		input["RTN_QTY"] =INQ_PARAMS.RTN_QTY;
		input["CPCT_CD"] =INQ_PARAMS.CPCT_CD;
		input["PRPS_CD"] =INQ_PARAMS.PRPS_CD;
		input["RTN_GTN"] =INQ_PARAMS.RTN_GTN; */
		gridRoot.removeAll();
	...
	function fn_reg_exec(){
	  ...
	  //취소버튼 이전화면으로
    function fn_cnl(){
   	 kora.common.goPageB('/CE/EPCE9000301.do', INQ_PARAMS);
    }
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="CPCT_CD" headerText="용량(신구병)" visible="false"  textAlign="center" width="200" />');
			layoutStr.push('			<DataGridColumn dataField="CPCT_NM" headerText="용량(신구병)"  textAlign="center" width="200" />');
			layoutStr.push('			<DataGridColumn dataField="PRPS_CD" headerText="용도" textAlign="center" visible="false" width="200" />');//지역
			layoutStr.push('			<DataGridColumn dataField="PRPS_NM" headerText="용도" textAlign="center" width="200" />');//지역
			layoutStr.push('			<DataGridColumn dataField="RTN_GTN" headerText="보증금" width="300" formatter="{numfmt}" id="num5" textAlign="right" />');//보증금
			layoutStr.push('			<DataGridColumn dataField="REG_SQ" headerText="등록번호" textAlign="center" width="50" />');
			...
			<section class="secwrap">
				...
				<div class="row">
						<div class="col">
							...
							<div class="box">
								<input type="text"  id="RCS_NM"  readonly="readonly" /> 
								<!-- <select id="RCS_NM" name="RCS_NM" style="x"></select> -->
								<input type="hidden" id ="REG_SQ" />
							</div>
						</div>
				...
				<div class="srcharea" id="divInput" > 
					...
					<div class="row">
						...
						<div class="col">
							...
							<div class="box">
								  <input type="text"  id="RTN_GTN"   class="i_notnull" />
							</div>
						</div>
						
					</div> <!-- end of row -->
					
					<div style="float:right ;margin-top: 10px" id="CR" ><button type="button" class="btn36 c5" style="width: 100px; margin-right: 5px;" id="btn_reg2">변경</button></div>
				</div>  <!-- end of srcharea -->
			</section>
