...
$(document).ready(function(){
	...
	function fn_init(){
 	...
 	function link(){
 		...
 		INQ_PARAMS["URL_CALLBACK"] = "/EP/EPCE00982882.do";
 		kora.common.goPage('/EP/EPCE00982883.do', INQ_PARAMS);
 	}
 	
 	//공지사항이동
 	function fn_page(){
 		INQ_PARAMS={};
 		kora.common.goPage('/EP/EPCE0098201.do', INQ_PARAMS);
 	}
 	 ...
 	 */
 	 function fnSetGrid1(reDrawYn) {
 			...
 			layoutStr.push('			<DataGridColumn dataField="FAQ_SEQ"	headerText="번호"		width="50"  textAlign="center"		    />');		//번호
	...
	<div class="layer_popup" style="width: 820px;">
		...
		<div class="layer_body">
			...
			<div class="secwrap mt30">
				<div class="tablist">
					<ul>
						<li ><a style="cursor: pointer;" id="btn_page1">공지사항</a></li>
						<li class="on"><a style="cursor: pointer;" id="btn_page2">FAQ</a></li>
					</ul>
					<div class="btnbox">
