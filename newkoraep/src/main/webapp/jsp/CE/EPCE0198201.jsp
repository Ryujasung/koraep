...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	//추가 
	function fn_reg() {
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0198201.do";
		kora.common.goPage('/CE/EPCE0198231.do', INQ_PARAMS);
	...
	function fn_upd() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0198201.do";
		kora.common.goPage('/CE/EPCE0198242.do', INQ_PARAMS);
	...
	function fn_lst() {
		...
		kora.common.goPageB('/CE/EPCE0128901.do', INQ_PARAMS);
	}
	...
	function fnSetGrid1(reDrawYn) {
		...
		layoutStr.push('			<DataGridColumn dataField="RTRVL_CTNR_CD"  headerText="'+ parent.fn_text('rtrvl_ctnr_cd')+ '"		width="100"	textAlign="center"/>');
		layoutStr.push('			<DataGridColumn dataField="CTNR_NM" headerText="'+ parent.fn_text('rtrvl_ctnr_nm')	+ '"	width="200"   textAlign="center"/>');
		layoutStr.push('			<DataGridColumn dataField="RTRVL_DPS"	 headerText="'+ parent.fn_text('rtrvl_dps2')	+ '"  	width="150"	textAlign="right" />');
