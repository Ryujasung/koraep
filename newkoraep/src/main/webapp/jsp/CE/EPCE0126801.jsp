...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	gridTotalRowCount = 0; //전체 행 수
     ...
     function fn_init(){
    	 	 ...
    	 	 kora.common.setEtcCmBx2(whsl_se_cdList, "","", $("#BIZR_TP_CD"), "ETC_CD", "ETC_CD_NM", "N" ,'T');		//소매업자구분 
    	 //	 kora.common.setEtcCmBx2(whsdlList, "","", $("#BIZRNM"), "BIZRID_NO", "BIZRNM", "N" ,'T');					//소매업자
   ...
   //조회
    function fn_sel(){
	 var input	={};
	 var url = "/CE/EPCE0126801_192.do" 
		  pagingCurrent = 1;
	 
	 /* 
	     if($("#BIZRNM").val() !="" && $("#BIZRNM").val() !=null){		//업체명
			 arr	 =[];
			 arr	 = $("#BIZRNM").val().split(";");
			 input["BIZRID"]   		= arr[0];
			 input["BIZRNO"]  		= arr[1];
	     ...
	     input["BIZRNM"]				=$("#BIZRNM").val();						//소매업자 아이디,넘버
	 	 input["BIZR_TP_CD"] 		=$("#BIZR_TP_CD").val();				//소매업자구분
	...
	function fn_upd3(){
		...
		var url = "/CE/EPCE0126888.do";		//지역설정
	...
	function fn_upd5(){
	    ...
	    parent_item= input;
		var pagedata = window.frameElement.name;
		var url = "/CE/EPCE01268882.do";		//단체설정
			window.parent.NrvPub.AjaxPopup(url, pagedata);
	}
	...
	function fn_upd4(){
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0126801.do";
		kora.common.goPage("/CE/EPCE0126842.do", INQ_PARAMS);
	}
	...
	function fn_reg(){
		INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0126801.do";
		kora.common.goPage("/CE/EPCE0126831.do", INQ_PARAMS);
	}
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="AFF_OGN_NM"			 		headerText="'+ parent.fn_text('aff_ogn')+ '" 			width="130"  textAlign="center"  />'); 							//소속
			layoutStr.push('			<DataGridColumn dataField="BIZRNM"							headerText="'+ parent.fn_text('rtl_nm')+ '"			width="250"  textAlign="left"		    />');							//소매
			layoutStr.push('			<DataGridColumn dataField="GRP_BRCH_NM" 				headerText="'+ parent.fn_text('grp_brch_nm2')+ '"	width="200"  textAlign="left" 	  />');							//총괄지점
			layoutStr.push('			<DataGridColumn dataField="BRCH_NM"			 			headerText="'+ parent.fn_text('brch')+ '" 				width="200"  textAlign="left"		  />'); 							//지점
...
<input type="hidden" id="whsdlList" value=""/>
		...
		<section class="secwrap"   id="params">
				<div class="srcharea" style="" > 
					<div class="row" >
						...
						<div class="col"  style="">
							<div class="tit" id="enp_nm"></div><!--소매업자 업체명-->
							<div class="box">
							<!-- 	<select id="BIZRNM" style="width :176px"></select> -->
								<input type="text" id="BIZRNM" style="width :176px" />
							</div>
						</div>
						<div class="col"  style="">
