...
<script type="text/javaScript" language="javascript" defer="defer">
     ...
     $(function() {
    	...
    	ctnr_se_list 	= jsonObject($("#ctnr_se_list").val());      
   		...
   		$('#CRCT_WRHS_CFM_DT').text(kora.common.setDelim(INQ_PARAMS.PARAMS.CRCT_WRHS_CFM_DT, '9999-99-99'));
	...
	insRow = function(gbn) {
		...
		for(var i=0; i<ctnr_nm.length; i++){
			...
			if(ctnr_nm[i].CTNR_CD == ctnrCd) { //같은 용기코드가 있을경우
				...
				input["CRCT_WRHS_CFM_DT"] 	=	INQ_PARAMS.PARAMS.CRCT_WRHS_CFM_DT;
			...
			<div class="srcharea" style="" id="divInput" > 
				<div class="row" >
					...
					<div class="col" style="">
						...
						<div class="box">
							<div class="calendar">
								<div class="txtbox" id="CRCT_WRHS_CFM_DT" style="width: 179px;margin-top: 7px;"></div>
							</div>
						</div> 
					</div>
				</div>
