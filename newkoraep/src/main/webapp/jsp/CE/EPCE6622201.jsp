...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function fn_sel(){
     ...
     //	kora.common.fnDateCompare ()    종료일이 시작일 보다 작을때 false 를 체크 해보자
		...
		input[ "RTN_DOC_NO"] = $("#RTN_DOC_NO").val()   //반환문서번호	
		input[ "WRHS_DOC_NO"] = $("#WRHS_DOC_NO").val()//입고문서번호	
	...
	/****************************************** 그리드 셋팅 시작***************************************** */
		...
		function fnSetGrid(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="REQ_DTTM" headerText="요청일자" width="8%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="RTN_DOC_NO" headerText="반환문서번호" width="12%" itemRenderer="HtmlItem"  textAlign="center" />');
			layoutStr.push('			<DataGridColumn dataField="WRHS_DOC_NO" headerText="입고문서번호" width="12%" textAlign="center" />');
			layoutStr.push('			<DataGridColumn dataField="BIZRNM" headerText="사업자명" width="17%" textAlign="center" />');
			layoutStr.push('			<DataGridColumn dataField="BRCH_NM" headerText="소속지점" width="17%" textAlign="center"/>');
			...
			layoutStr.push('			<DataGridColumn dataField="ALT_REQ_STAT_NM" headerText="상태" width="10%" textAlign="center"/>');
					...
					<div class="srcharea" id="divInput">
						<div class="row">
							...
							<div class="col" style="width:300px">  <!-- 생산자 선택 -->
								<div class="tit" id="mfc_bizrnm_sel" style="width:90px"></div>
								<div class="box">
						...
						<div class="row">
							...
							<div class="col">
								<div class="tit" style="width:90px">반환문서번호</div>
								<div class="box" style="width:380px">
									<input type="text" id="RTN_DOC_NO" maxlength="15"	style="width: 180px; text-align: center;"  alt="반환문서번호 " >
								</div>
							</div>
							<div class="col" style="width:300px">
								<div class="tit" style="width:90px">입고문서번호</div>
								<div class="box">
									<input type="text" id="WRHS_DOC_NO" maxlength="15"	style="width: 180px; text-align: center;"  alt="입고문서번호" >
								</div>
							</div>
