...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   //변경 페이지 이동 
  	function fn_upd() {
 		...
 		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE9000301.do";

 		kora.common.goPage('/CE/EPCE9000342.do', INQ_PARAMS);
  	}
    ...
    function fn_init(){
		...
		kora.common.setEtcCmBx2(whsl_se_cdList, "","", $("#WHSL_SE_CD"), "ETC_CD", "ETC_CD_NM", "N" ,'T');//도매업자구분 
	 	kora.common.setEtcCmBx2(whsdlList, "","", $("#WHSDL_BIZRNM"), "RCS_NO", "RCS_NM", "N" ,'T');//도매업자 업체명
   ...
   function fn_del(){
	...
	function fn_page() {
		INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE9000301.do";
		kora.common.goPage('/CE/EPCE9000331.do', INQ_PARAMS);
	}
	//반환관리 상세
	function link(){
		...
		INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE9000301.do";
		kora.common.goPage('/CE/EPCE9000364.do', INQ_PARAMS);
	}
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
		...
		//layoutStr.push('			<DataGridColumn dataField="PNO" headerText="순번" textAlign="center" width="50" draggable="false"/>');//순번
		layoutStr.push('			<DataGridColumn dataField="REG_SQ" headerText="순번"  textAlign="center" width="50" 	 visible="false"	  />');
		...
		layoutStr.push('			<DataGridColumn dataField="RTN_QTY" headerText="회수량"  formatter="{numfmt}" id="num6" textAlign="right" width="150"  />');//도매업자구분
		...
		layoutStr.push('			<DataGridColumn dataField="RTN_GTN" headerText="보증금" width="150" formatter="{numfmt}" id="num5" textAlign="right" />');//보증금
    ...
    <div class="iframe_inner"  >
			...
			<section class="secwrap"  id="params">
				...
				<div class="row" >
					...
					<div class="col" >
							<div class="tit" >반환수집소명</div>  <!--반환수집소 지점-->
							<div class="box">
