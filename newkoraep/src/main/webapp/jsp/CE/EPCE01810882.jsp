...
$(document).ready(function(){
	...
	//선택데이터 팝업화면에 셋팅
	function fn_init() {
		console.log("asdas :  "+aff_ogn_cd_list)
	...
	//저장 확인
  	function fn_reg_chk(){
		confirm(parent_item.aff_ogn_cnt+"개 지점의 지역 정보가 변경됩니다. 계속 진행하시겠습니까?","fn_reg");
  	}
 	 //저장
 	 function fn_reg(){
		...
		var input = {"list": ""};
			for(var i =0; i<parent_item.list.length; i++){
				parent_item.list[i].AFF_OGN_CD = $("#AFF_OGN_CD").val();
			}
