...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   //생산자ERP입고정보  조회
	...
	function fn_lst() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0130201.do";
		kora.common.goPage('/CE/EPCE0130001.do', INQ_PARAMS); 
	}
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="MFC_BIZRNM" headerText="'+ parent.fn_text('mfc_bizrnm')+ '"  width="230" id="tmp1" textAlign="center" />');//생산자
