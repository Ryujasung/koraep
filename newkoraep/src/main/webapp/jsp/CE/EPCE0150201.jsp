...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	gridTotalRowCount = 0; //전체 행 수
     ...
     //초기화
     function fn_init(){
    	 	 kora.common.setEtcCmBx2(mfc_bizrnmList, "","", $("#BIZRNM"), "BIZRID_NO", "BIZRNM", "N" ,'T');			//생산자
   ...
   //조회
	...
	function fn_upd3(){
		...
		var url = "/CE/EPCE0150288.do";		//지역설정
	...
	function fn_upd4(){
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0150201.do";
		kora.common.goPage("/CE/EPCE0150242.do", INQ_PARAMS);
	}
	...
	function fn_reg(){
		INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0150201.do";
		kora.common.goPage("/CE/EPCE0150231.do", INQ_PARAMS);
	}
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="BRCH_NM"			headerText="'+ parent.fn_text('mfc_brch_nm')+ '" width="200"  textAlign="center"		  />'); 							//직매장
