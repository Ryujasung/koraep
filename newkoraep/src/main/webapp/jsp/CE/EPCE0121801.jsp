	...
	<script type="text/javaScript" language="javascript" defer="defer">
	  ...
	  //취급정보 삭제
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0121801.do";
			kora.common.goPage('/CE/EPCE0121831.do', INQ_PARAMS);
		}
		/**
		 * 등록팝업 이동
		 */
...
<input type="hidden" id="statList" value="<c:out value='${statList}' />"/>
	...
	<div class="iframe_inner">
			...
			<div class="srcharea" id="sel_params">
				<div class="row">
					...
					<div class="col" style="display:none">
						<div class="tit" id="area" style="width:120px"></div>
						<div class="box">
		...
		<div class="boxarea mt10">
			<div id="gridHolder" style="height:555px;background: #FFF;""></div>
