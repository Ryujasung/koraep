	     ...
	     function fn_upd(){
	    	 ...
	    	 var chkLst = selectorColumn.getSelectedItems();
				...
				INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		 		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6658201.do";
	
		 		kora.common.goPage('/CE/EPCE6658242.do', INQ_PARAMS);
	     }
...
// 			hideLoadingBar();
	...
	function fn_reg(){
		INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6658201.do";
		kora.common.goPage('/CE/EPCE6652931.do', INQ_PARAMS);
	}
...
/****************************************** 그리드 셋팅 시작***************************************** */
	...
	//상세조회 링크
	 function link() {
			...
			INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6658201.do";
			kora.common.goPage('/CE/EPCE66582641.do', INQ_PARAMS);
