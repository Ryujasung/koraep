...
//    				hideLoadingBar(); 
   ...
   function fn_cnl(){
	...
	function fn_page(){
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE2925888.do";
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="RTRVL_DT"		headerText="'+ parent.fn_text('rtrvl_dt2') + '"  		width="250"  	textAlign="center"  	/>'); 											//회수일자										
						...
						<div class="write_tbl">
							...
							<tbody>
								 <tr>
									...
									<th class="bd_l" id="sel_term"></th> <!--조회기간-->
									<td>
										<div class="row" style="overflow: visible;">
										 		<div class="box" style="width: 73%">
													<div class="calendar" style="width: 43%">
														<input type="text" id="START_DT" name="from" style="" class="i_notnull"><!-- 시작날짜  -->
													</div>
													<div class="obj">~</div>
													<div class="calendar" style="width: 43%">
														<input type="text" id="END_DT" name="to" style=""	class="i_notnull"><!-- 끝날짜 -->
													</div>
												</div>
