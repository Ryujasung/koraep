...
<script type="text/javaScript" language="javascript" defer="defer" >
		...
		function fn_upd_exec(){
			...
			data["DLIVY_CRCT_STAT_CD"] = dlivyCrctStatCd;

			var url = "/CE/EPCE4759401_21.do";
		...
		function fn_upd(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE4759401.do";
			kora.common.goPage('/CE/EPCE4759442.do', INQ_PARAMS);
		}
	...
	function fn_reg(){
		...
		INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE4759401.do";
		kora.common.goPage('/CE/EPCE4759431.do', INQ_PARAMS);
	}
