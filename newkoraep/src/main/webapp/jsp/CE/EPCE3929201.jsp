...
// 		input['excelYn'] = 'Y';	//엑셀 저장시 모든 검색이 필요해서
	...
	/****************************************** 그리드 셋팅 시작***************************************** */
		...
		function fnSetGrid(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="LGN_LGOT" headerText="로그인구분" width="10%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="REG_TIME" headerText="일시" width="15%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="ACCS_BRSR" headerText="접속 브라우저" width="10%" textAlign="center"/>');
				           ...
				           <div class="col">
								...
								<div class="box">
									<select style="width: 150px;" id="LGN_LGOT"  >
									   <option value='LGN'>로그인</option>
									   <option value='LGOT'>로그아웃</option>
									</select>
								</div>
							</div>
