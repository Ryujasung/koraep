...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   //입고정정확인  조회
	...
	function dtl_link(data){
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE4704201.do";
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="CUST_BRCH_NM"			 	headerText="'+ parent.fn_text('whsdl')+ '" 			width="130"  textAlign="center"  />'); 												//도매업자지점
            ...
            layoutStr.push('                <DataGridFooterColumn labelJsFunction="totalsum11"  formatter="{numfmt1}" dataColumn="{num11}" textAlign="right"/>');   
