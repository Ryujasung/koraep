...
// 				hideLoadingBar(); 
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('				<DataGridColumn dataField="RTRVL_RT_H" headerText="'+ parent.fn_text('fh_rt')+ '" 	width="100" formatter="{percfmt}"	textAlign="right" />');					//가정용비율
			...
			layoutStr.push('				<DataGridColumn dataField="RTRVL_CPR_RTRVL_RT_H" headerText="'+ parent.fn_text('fh_rt')+ '" 		width="100" formatter="{percfmt}"	textAlign="right" id="tmp1" />');						//가정용비율
			layoutStr.push('			</DataGridColumnGroup>');
			
			layoutStr.push('			<DataGridColumnGroup headerText="'+ parent.fn_text('rtrvl_cpr_rtn_rt')+ '">');
			layoutStr.push('				<DataGridColumn dataField="CFM_RTRVL_PER_H" headerText="'+ parent.fn_text('fh')+ '" width="100" formatter="{percfmt}" textAlign="right" id="tmp2" />');
			layoutStr.push('				<DataGridColumn dataField="CFM_RTRVL_PER_M" headerText="'+ parent.fn_text('fb')+ '" width="100" formatter="{percfmt}" textAlign="right" id="tmp3" />');
			layoutStr.push('			</DataGridColumnGroup>');
		...
		<section class="secwrap"   id="params">
				<div class="srcharea mt10" > 
							<div class="row" >
									...
									<div class="col" >
										<div class="tit" id="prps_cd_txt"></div>  <!--초과량만표시 -->
										<div class="box">
			...
			<div class="h4group" >
					<h5 class="tit"  style="font-size: 16px;">
						&nbsp;※ 조회기간의 기준은 회수일자, 입고확인일자(정산 후) 입니다.<br/>
					</h5>  
			</div>
