...
// 		$('#user_se_cd_sel').text(parent.fn_text('user_se'));
	 ...
	 */
	 function fn_set_grid() {
		 ...
		 layoutStr.push('	<DataGridColumn itemRenderer="IndexNoItem" headerText="순번" width="50" verticalAlign="middle" />');
		 layoutStr.push('	<DataGridColumn dataField="URM_UPD_DT"  headerText="변경일자" width="100" />');
		 layoutStr.push('	<DataGridColumn dataField="URM_NM"  headerText="무인회수기명" width="200"/>');
		 layoutStr.push('	<DataGridColumn dataField="SERIAL_NO"  headerText="무인회수기시리얼번호" width="150"/>');
		 layoutStr.push('	<DataGridColumn dataField="START_DT"  headerText="설치일자" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="END_DT"  headerText="철거일자" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="URM_USE_DT"  headerText="최초설치일자" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="URM_DE_DT"  headerText="품질보증만료일자" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="PNO"  headerText="우편번호" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="ADDR"  headerText=" 주소" width="200"/>');
		 layoutStr.push('	<DataGridColumn dataField="USE_TOT"  headerText="총량" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="URM_TYPE_NM"  headerText="무인회수기 유형" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="USE_YN"  headerText="사용여부" width="100"/>');
		 layoutStr.push('	<DataGridColumn dataField="REG_PRSN_ID"  headerText="수정자ID" width="110"/>');
		 layoutStr.push('	<DataGridColumn dataField="REG_DTTM"  headerText="수정일시" width="130"/>');
