...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			$('.row > .col > .tit, .write_area .write_tbl table tr th.bd_l').each(function(){
				$(this).text(parent.fn_text($(this).attr('id')) );
			});

			$('#RTL_RTN_REG_DT').text(kora.common.setDelim(INQ_PARAMS.PARAMS.RTL_RTN_REG_DT, '9999-99-99'));
	   ...
	   function fn_ctnr_cd(){
			...
			ctnr_nm=[];
 			...
 			input["BIZRID"] 		    = INQ_PARAMS.PARAMS.MFC_BIZRID; //생산자 아이디
			input["BIZRNO"]			= INQ_PARAMS.PARAMS.MFC_BIZRNO; //생산자 번호
	    ...
	    //행추가
	 	...
	 	insRow = function(gbn) {
			...
			input["MFC_BRCH_NM"] = INQ_PARAMS.PARAMS.MFC_BRCH_NM;
		...
		//등록
	     function fn_reg(){
	 		...
	 		if(0 != collection.getLength()){
				...
				alertMsg("저장할 자료가 없습니다.\n\n자료를 입력 후 행추가 버튼을 클릭하여 저장할 자료를 여러건 입력한 다음 저장 버튼을 클릭하세요.");
			}
		}
				...
				<div class="write_area">
					<div class="write_tbl">
						<table>
							...
							<tbody>
								<tr>
									<th class="bd_l"  id="drct_rtn_reg_dt"></th>
									<td>
										<div class="row">
											<div class="txtbox" id="RTL_RTN_REG_DT"></div>
										</div>
									</td>
									<th class="bd_l"  id="drct_rtn_mfc"></th>
									<td>
										<div class="row">
