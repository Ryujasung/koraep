...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		$(document).ready(function(){
			...
			kora.common.setEtcCmBx2([], "","", $("#MENU_CD"), "ETC_CD", "ETC_CD_NM", "N","T");
			kora.common.setEtcCmBx2([], "", "", $("#BTN_CD"), "ETC_CD", "ETC_CD_NM", "N","T");
...
//	 		input['excelYn'] = 'Y';	//엑셀 저장시 모든 검색이 필요해서
	...
	function link() {
		...
		window.parent.NrvPub.AjaxPopup('/CE/EPCE3961264.do', pagedata);
	}
	...
	/****************************************** 그리드 셋팅 시작***************************************** */
		...
		function fnSetGrid(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="USER_ID" headerText="아이디" width="10%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="USER_NM" headerText="성명" width="10%" itemRenderer="HtmlItem"  textAlign="center" />');
			layoutStr.push('			<DataGridColumn dataField="BIZRNM" headerText="사업자명" width="15%" textAlign="center" />');
			layoutStr.push('			<DataGridColumn dataField="BRCH_NM" headerText="소속지점" width="10%" textAlign="center" />');
			layoutStr.push('			<DataGridColumn dataField="ETC_CD_NM" headerText="업무구분" width="25%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="MENU_GRP_NM" headerText="메뉴명" width="15%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="MENU_NM" headerText="화면명" width="15%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="BTN_NM" headerText="버튼명" width="7%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="REG_TIME" headerText="실행일시" width="15%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="ACSS_IP" headerText="접속 IP" width="10%" textAlign="center"/>');
			layoutStr.push('			<DataGridColumn dataField="PARAM" headerText="파라미터" width="10%" textAlign="center" itemRenderer="HtmlItem"/>');
  	...
  	<div class="iframe_inner">
			...
			<div class="h3group">
				<h3 class="tit" id="title"></h3>
						...
						<div class="btn">
								<button type="button" class="btn36 c2" style="width: 120px; float:right;" id="btn_excel">엑셀저장</button>
							</div>
			</div>
					...
					<div class="srcharea" id="divInput">
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="box">
									<select id="MENU_SET_CD" ></select>
								</div>
							</div>
							<div class="col" >
								<div class="tit" id="sc_nm"></div>
								<select  id="MENU_CD"  ></select>
							</div>
							<div class="col">
								<div class="tit">버튼명</div>
								<select  id="BTN_CD"></select>
							</div>
							<div class="btn">
