...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="DRCT_RTRVL_REG_DT" headerText="'+parent.fn_text('drct_rtrvl_reg_dt')+'" width="100" formatter="{datefmt}" id="tmp2"/>');
			layoutStr.push('		</groupedColumns>');
