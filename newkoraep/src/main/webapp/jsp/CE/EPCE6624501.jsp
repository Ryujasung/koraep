...
border-radius:10px; 
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			grid_info = jsonObject($("#grid_info_list").val());
			...
			var exchStatList = jsonObject($("#exchStatList_list").val());
			var dtList = jsonObject($("#dtList_list").val());
			var bizrNmList = jsonObject($("#bizrNmList_list").val());
			var reqBrchList = jsonObject($("#reqBrchList_list").val());
			var cfmBrchList = jsonObject($("#cfmBrchList_list").val());
			...
			kora.common.setEtcCmBx2(bizrNmList, "", "", $("#REQ_MFC_SEL"), "BIZRID_NO", "BIZRNM", "N", "T");
			kora.common.setEtcCmBx2(bizrNmList, "", "", $("#CFM_MFC_SEL"), "BIZRID_NO", "BIZRNM", "N", "T");
			 ...
			 ***********************************/
			 $("#CFM_MFC_SEL").change(function(){
					fn_bizrTpCd($(this), $("#CFM_MFC_BRCH_SEL"));
			 });
...
// 				kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6624501.do";
			kora.common.goPage('/CE/EPCE6624531.do', INQ_PARAMS);
		}
		 ...
		 */
		 function fn_set_grid() {
			 ...
			 layoutStr.push('	<DataGridColumn dataField="EXCH_STAT_NM" id="tmp2" headerText="'+parent.fn_text('stat')+'" width="100"/>');
			 layoutStr.push('</groupedColumns>');
		...
		function fn_page(){
			...
			input["EXCH_CFM_DT"] = gridRoot.getItemAt(rowIndex)["EXCH_CFM_DT"];
			input["EXCH_STAT_NM"] = gridRoot.getItemAt(rowIndex)["EXCH_STAT_NM"];
			
			INQ_PARAMS["PARAMS"] = input;
			INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6624501.do";
			kora.common.goPage('/CE/EPCE6624564.do', INQ_PARAMS);
		}
...
<body>
	<div class="iframe_inner">
    	...
    	<input type="hidden" id="exchStatList_list" value="<c:out value='${exchStatList}' />" />
    	<input type="hidden" id="dtList_list" value="<c:out value='${dtList}' />" />
    	<input type="hidden" id="bizrNmList_list" value="<c:out value='${bizrNmList}' />" />
    	<input type="hidden" id="reqBrchList_list" value="<c:out value='${reqBrchList}' />" />
    	<input type="hidden" id="cfmBrchList_list" value="<c:out value='${cfmBrchList}' />" />
			...
			<div class="srcharea" id="sel_params">
				...
				<div class="row">
					<div class="col">
						...
						<div class="box">						
							<select id="EXCH_STAT_CD_SEL" name="EXCH_STAT_CD_SEL" style="width: 130px;"></select>
