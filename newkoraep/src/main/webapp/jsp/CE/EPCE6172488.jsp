...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			$('#MFC_BIZRNM').text(parent_item.MFC_BIZRNM);
			$('#CTNR_NM').text(parent_item.CTNR_NM);
			
			$('#RTN_QTY').text(kora.common.format_comma(parent_item.STD_WRHS_CFM_QTY));
			$('#RTN_REVI_QTY').val(kora.common.format_comma(parent_item.REVI_QTY));
		...
		function fn_upd_exec(){
			...
			data['RTN_REVI_QTY'] = $('#RTN_REVI_QTY').val().replace(/\,/g,"");
			
			var url  = "/CE/EPCE6172488_21.do";
					...
					<div class="write_area">
						<div class="write_tbl">
							<table>
								...
								<tr>
									<th><span id="mfc_bizrnm_txt"></span></th>
									<td>
										<div class="row" >
								...
								<tr>
									...
									<td>
										<div class="row" >
											<input type="text" id="RTN_REVI_QTY" style="width:179px" format="minus" />
