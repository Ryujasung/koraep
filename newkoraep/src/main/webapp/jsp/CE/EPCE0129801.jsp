...
<script src="/js/kora/paging_common.js"></script>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0129801.do";
			kora.common.goPage('/CE/EPCE0129831.do', INQ_PARAMS);
		}
		...
		function fn_upd(){
			...
			INQ_PARAMS["FN_CALLBACK" ] = "fn_sel";
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0129801.do";
			kora.common.goPage('/CE/EPCE0129842.do', INQ_PARAMS);
		}
