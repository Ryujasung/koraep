...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    function fn_lst(){
    	kora.common.goPageB('/CE/EPCE0130001.do', INQ_PARAMS);
    }
     
   //입고관리 조회
    function fn_sel(){
		 var input = {};
		 var url = "/CE/EPCE0130101_194.do" 
		...
		/* input["WRHS_CFM_DT"] = "20180628";
		input["MFC_BIZRID"] = "M1S0002015";
		input["MFC_BIZRNO"] = "f831f328b387fe40865a2ca6a5b44a1f";
		input["WHSDL_BIZRID"] = "W1S0000579";
		input["WHSDL_BIZRNO"] = "4a0d68734708f1bd18c153e2e24d0198";
		input["MFC_BRCH_ID"] = "M100002391";
		input["MFC_BRCH_NO"] = "1418502567"; */
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="WHSDL_BIZRNO" 			headerText="'+ parent.fn_text('whsdl_bizrno')+ '" formatter="{maskfmt1}" width="100" id="tmp3" textAlign="center" />');				//도매업자 사업자 번호
			layoutStr.push('		</groupedColumns>');
