...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(function() {
	      ...
	      ctnrNmList_C 	= jsonObject($("#ctnr_cdList").val());				//빈용기 원본
	      whsdlList_C 		= jsonObject($("#whsdlList").val());				//도매업자 업체명 조회 원본
	     
	      ctnrNmList		=	ctnrNmList_C			//빈용기
	      whsdlList 			=  whsdlList_C 		//도매업자 업체명 조회
...
// 			hideLoadingBar(); 
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
            ...
            layoutStr.push('            <DataGridColumn dataField="ALKND_NM"         headerText="'+ parent.fn_text('alknd_cd')+ '"            width="100"     textAlign="center"  />');                                                   //빈용기명
...
<body>
    ...
    <div class="iframe_inner" >
			...
			<input type="hidden" id="ctnr_cdList" value="<c:out value='${ctnr_cd}' />" />
				...
				<div class="srcharea" > 
							...
							<div class="row">
									<div class="col" >
										...
										<div class="box">
											<select id="BIZR_TP_CD" style="width: 169px" ></select>
										</div>
									</div>
									<div class="col" ">
