   ...
   /**
	 ...
	 */
	 function fn_set_grid() {
		 ...
		 layoutStr.push('	<DataGridColumn dataField="EXCA_REG_DT" headerText="'+parent.fn_text('bill_issu_dt')+'" width="100" formatter="{datefmt}" />');
		 layoutStr.push('	<DataGridColumn dataField="EXCA_AMT" id="sum" headerText="'+parent.fn_text('noty_amt')+'" width="100" formatter="{numfmt}" textAlign="right"/>');
		 layoutStr.push('</groupedColumns>');
