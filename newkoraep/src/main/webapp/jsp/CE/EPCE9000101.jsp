...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	gridTotalRowCount = 0; //전체 행 수
     ...
     var pbox_bizr_list;//도매업자 업체명 조회
	 var brch_cd_List;//지점
     var stat_cd_list;//상태
     var prpsCdList;        //용도코드
     ...
     $(function() {
  	  ...
  	  pbox_bizr_list 		= jsonObject($("#pbox_bizr_list").val());		//도매업자 업체명 조회
     ...
     function fn_init(){
			 ...
			 kora.common.setEtcCmBx2(bizr_tp_cd_list, "","", $("#BIZR_TP_CD"), "ETC_CD", "ETC_CD_NM", "N" ,'T');							//도매업자구분 
		 	 kora.common.setEtcCmBx2(pbox_bizr_list, "","", $("#WHSDL_BIZRNM"), "WHSDL_BIZRNO", "WHSDL_BIZRNM", "N" ,'T');		//도매업자 업체명
		 	kora.common.setEtcCmBx2(whsdl_cd_list, "","", $("#WHSDL_BIZRNM2"), "CUST_BIZRID_NO", "CUST_BIZRNM", "N" ,'T');		//도매업자 업체명
		 	kora.common.setEtcCmBx2(pbox_bizr_list, "","", $("#WHSDL_BIZRNM3"), "WHSDL_BIZRNO", "WHSDL_BIZRNM", "N" ,'T');		//도매업자 업체명
   ...
   //회수정보관리 조회
    function fn_sel(){
		...
		input["WHSDL_BIZRNO"] 	= $("#WHSDL_BIZRNM option:selected").val(); 
...
// 					$("#t5").text(rtnData.amt_tot_list[0].T5);
   ...
   //회수등록일괄확인
    ...
    function fn_add(){
    	var input = {};
    	var arr	= new Array();
		arr	= $("#WHSDL_BIZRNM2").val().split(";");
		input["WHSDL_BIZRNO"] = arr[1];
		
    	INQ_PARAMS["SEL_PARAMS"] 	= input;
    	//INQ_PARAMS["WHSDL_BIZRNM"] = "";
   		 kora.common.goPageB('/CE/EPCE9000101_2.do', INQ_PARAMS);
    }
    function fn_del2(){
    	var input = {};
		input["WHSDL_BIZRNO"] = $("#WHSDL_BIZRNM3").val();
		
    	INQ_PARAMS["SEL_PARAMS"] 	= input;
      	 kora.common.goPageB('/CE/EPCE9000101_3.do', INQ_PARAMS);
       }
   ...
   function fn_del(){
	...
	function fn_page() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE9000101.do";
		kora.common.goPage('/CE/EPCE9000131.do', INQ_PARAMS);
	}
	//회수정보변경 페이지 이동 
	function fn_page2() {
		var selectorColumn 	=	gridRoot.getObjectById("selector");
		...
		INQ_PARAMS["FN_CALLBACK"] 		= "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] 	= "/CE/EPCE9000101.do";
		kora.common.goPage('/CE/EPCE9000142.do', INQ_PARAMS);
	}
	...
	function fn_page3() {
		...
		INQ_PARAMS={};
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE9000101.do";
		kora.common.goPage('/CE/EPCE9000197.do', INQ_PARAMS);
	}
	...
	function link(){
		...
		INQ_PARAMS["FN_CALLBACK"] = "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE9000101.do";
		kora.common.goPage('/CE/EPCE9000164.do', INQ_PARAMS);
	}
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('            <DataGridColumn dataField="CUST_BIZRNM"      headerText="소매업체명"  width="200"   textAlign="center"   />');                    //회수처 사업자번호
			layoutStr.push('			<DataGridColumn dataField="CUST_BIZRNO"			 	headerText="소매업체 사업자번호" 			width="200"  formatter="{maskfmt1}"	textAlign="center"  	 />'); 				
			layoutStr.push('            <DataGridColumn dataField="WHSDL_BIZRNM"      headerText="도매업체명"  width="200"   textAlign="center"   />');                    //회수처 사업자번호//지역
...
<body>
    <div class="iframe_inner"  >
			...
			<input type="hidden" id="pbox_bizr_list" value="<c:out value='${pbox_bizr_list}' />" />
		...
		<section class="secwrap"  id="params">
				<div class="srcharea" > 
					<div class="row">
							...
							<div class="col"  style="width:430px">
									<div class="tit" id="" style="width:135px">도매업자 사업자번호</div><!--소매업자 사업자번호-->
									<div class="box">
										<input type="text" id=WHSDL_BIZRNO_DE style="width:185px" format="number"></select>
									</div>
							</div>
							<div class="btn"  id="CR" ><button type="button" class="btn36 c1" style="width: 100px;" id="btn_sel">조회</button></div>
					</div> <!-- end of row -->
			...
			<section class="secwrap2 mt20">
					<div class="srcharea" > 
							<div class="row">
								<div class="col" >
										<div class="tit"  style="width:130px">PBOX도매업자추가</div> <!--  도매업자명 -->
										<div class="box"  >
								...
								<div class="col"  style="width:150px">
										<div class="box"  >
											  <button type="button" class="btn36 c2" style="width: 80px;" id="btn_add">추가</button>
										</div>
								</div>
								<div class="col" >
										<div class="tit"  style="width:130px">PBOX도매업자삭제</div> <!--  도매업자명 -->
										<div class="box"  >
								...
								<div class="col" >
										<div class="box"  >
											  <button type="button" class="btn36 c5" style="width: 80px;" id="btn_del2">삭제</button>
										</div>
								</div>
...
<!-- 			<div class="btn" id="GL"></div> -->
			<div class="btn" style="float:right" id="GR"><button type="button" class="btn36 c3" style="width: 130px;" id="btn_del">P-BOX정보삭제</button><button type="button" class="btn36 c3" style="width: 130px;" id="btn_page2">P-BOX정보변경</button><button type="button" class="btn36 c2" style="width: 130px;" id="btn_page">P-BOX정보등록</button></div>
		</section>
