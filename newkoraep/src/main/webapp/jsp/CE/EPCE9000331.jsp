...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	insRow = function(gbn) {
		...
		input["CPCT_NM"] 					=	$("#CPCT_CD option:selected").val();		
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="RTRVL_DT" headerText="회수일자"  textAlign="center" width="200"  />');//반환문서번호
			...
			layoutStr.push('			<DataGridColumn dataField="RTN_QTY" headerText="회수량" width="200" formatter="{numfmt}" id="num8"  textAlign="right" />');//회수량
			...
			layoutStr.push('			<DataGridColumn dataField="RTN_GTN" headerText="보증금" width="200" formatter="{numfmt}" id="num5" textAlign="right" />');//보증금
