...
<script src="/js/kora/paging_common.js"></script>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_tp(){
			...
			if( parent_item.BIZR_TP_CD != 'W1' && parent_item.BIZR_TP_CD != 'W2' ){
				alertMsg("도매업자 혹은 공병상 거래구분변경만 가능합니다.");
				return;
			}
			
			var pagedata = window.frameElement.name;
			window.parent.NrvPub.AjaxPopup('/CE/EPCE0120602.do', pagedata);
		}
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0120601.do";
			kora.common.goPage('/CE/EPCE0120631.do', INQ_PARAMS);
		}
