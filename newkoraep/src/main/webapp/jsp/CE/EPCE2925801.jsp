...
//       			hideLoadingBar();// 그리드 loading bar on
   ...
   function fn_del(){
	...
	function fn_page() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE2925801.do";
		kora.common.goPage('/CE/EPCE2925831.do', INQ_PARAMS);
	}
	//회수정보변경 페이지 이동 
	function fn_page2() {
		var selectorColumn 	=	gridRoot.getObjectById("selector");
		...
		INQ_PARAMS["FN_CALLBACK"] 		= "fn_sel";
		INQ_PARAMS["URL_CALLBACK"] 	= "/CE/EPCE2925801.do";
		kora.common.goPage('/CE/EPCE2925842.do', INQ_PARAMS);
	}
	...
	function fn_page3() {
		...
		INQ_PARAMS={};
		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE2925801.do";
		kora.common.goPage('/CE/EPCE2925897.do', INQ_PARAMS);
	}
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="AREA_NM"			 				headerText="'+ parent.fn_text('area')+ '" 			width="70" 	textAlign="center"  	 />'); 										//지역
			...
			layoutStr.push('			<DataGridColumn dataField="SYS_NM" 							headerText="'+ parent.fn_text('reg_se')+ '" width="50" id="tmp1" textAlign="center" />');														//등록구분
			layoutStr.push('		</groupedColumns>');
    ...
    <div class="iframe_inner"  >
		...
		<section class="secwrap"  id="params">
				<div class="srcharea" > 
					...
					<div class="row" >
							<div class="col"  style="width:430px;">
								<div class="tit" id="sel_term_txt" style="width:85px"></div>	<!-- 조회기간 -->
