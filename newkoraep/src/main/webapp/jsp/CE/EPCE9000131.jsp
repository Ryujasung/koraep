...
// 			return;
		...
		if(!kora.common.gfn_bizNoCheck($('#RTL_CUST_BIZRNO').val())){
			alertMsg("정상적인 사업자등록번호가 아닙니다.");
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			//layoutStr.push('			<DataGridColumn dataField="BOX_SE_CD"  		headerText="상태코드" 				width="120" 	textAlign="center" 		  />');		//회수량
 			layoutStr.push('			<DataGridColumn dataField="AREA_CD"  		headerText="지역" 	visible="false"			width="120" 	textAlign="center" 		  />');
