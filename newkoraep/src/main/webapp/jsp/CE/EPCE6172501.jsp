...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    function fn_pop(){
        ...
        window.parent.NrvPub.AjaxPopup('/CE/EPCE6172588.do', pagedata);
    }

    function fn_page(){

        INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6172501.do";
        kora.common.goPage('/CE/EPCE61725012.do', INQ_PARAMS);
    ...
    function fn_page2(){
        ...
        INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE6172501.do";
        kora.common.goPage('/CE/EPCE6172542.do', INQ_PARAMS);
...
//             kora.common.hideLoadingBar(dataGrid, gridRoot);
    ...
    function fnSetGrid1(reDrawYn) {
        ...
        layoutStr.push('            <DataGridColumn dataField="RTRVL_QTY" headerText="'+ parent.fn_text('rtrvl_qty2')+ '" width="100" id="sum1" textAlign="right" formatter="{numfmt}" />');
