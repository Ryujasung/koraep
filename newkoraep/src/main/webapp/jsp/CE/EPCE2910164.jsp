...
<script type="text/javaScript" language="javascript" defer="defer">
 	...
 	function fn_excel(){
 		...
 		input['GBN'] = INQ_PARAMS.PARAMS.GBN;
 		var url = "/CE/EPCE2910164_05.do";
    ...
    function  fn_init(){
     ...
     function fn_page(){
    	 ...
    	 if(gridList[0].RTN_STAT_CD != 'RG' && gridList[0].RTN_STAT_CD != 'RA'){
    		 alertMsg("반환등록, 반환등록요청 상태의 반환정보만 변경 가능합니다. 다시 한 번 확인하시기 바랍니다.");
    		 return;
    	 }
    	 
    	 var input = INQ_PARAMS.PARAMS;
    	 if(input.RTN_DOC_NO_L != null ){
    		 alertMsg("반환내역서 작성/조회 메뉴에서 변경해주시기 바랍니다.");
    		 return;
    	 }
    	//파라미터에 조회조건값 저장 
 		INQ_PARAMS["PARAMS"] = {}
 		...
 		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE2910164.do";
//  		INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE2910164.do";
...
<form name="prtForm3" id="prtForm3">
		<input type="hidden" name="CRF_NAME" value="EPCE2910164_2.crf" />	<!-- 필수 -->
	<input type="hidden" name="RTN_DOC_NO"   id="RTN_DOC_NO"  />
	<input type="hidden" name="MFC_BIZRID"  id="MFC_BIZRID" />
	<input type="hidden" name="MFC_BIZRNO"  id="MFC_BIZRNO"   />
	<input type="hidden" name="WHSDL_BIZRID" id="WHSDL_BIZRID"    />
