...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			searchList = jsonObject($("#searchList_list").val());
			reqCtnrList	= jsonObject($("#reqCtnrList_list").val());
			cfmCtnrList = jsonObject($("#cfmCtnrList_list").val());
		...
		function fn_reg2_exec(){
			...
			data["EXCH_REQ_DOC_NO"] = INQ_PARAMS.PARAMS.EXCH_REQ_DOC_NO;
		...
		function fn_dataCheck(gbn, input, idx){
			...
			//input['BIZRID_NO'] = INQ_PARAMS.PARAMS.REQ_MFC_BIZRID +";"+ INQ_PARAMS.PARAMS.REQ_MFC_BIZRNO;
		...
		function insRow(gbn){
			...
			input["EXCH_REQ_DOC_NO"] = INQ_PARAMS.PARAMS.EXCH_REQ_DOC_NO;
			input["EXCH_DT"] = INQ_PARAMS.PARAMS.EXCH_DT;
...
<body>
	<div class="iframe_inner">
    	...
    	<input type="hidden" id="searchList_list" value="<c:out value='${searchList}' />" />
    	<input type="hidden" id="reqCtnrList_list" value="<c:out value='${reqCtnrList}' />" />
    	<input type="hidden" id="cfmCtnrList_list" value="<c:out value='${cfmCtnrList}' />" />
