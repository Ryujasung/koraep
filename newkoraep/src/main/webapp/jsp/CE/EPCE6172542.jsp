...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		$(document).ready(function(){
			...
			$('#RTRVL_QTY_2016').text(kora.common.format_comma(searchDtl.RTRVL_QTY_2016));
			$('#RTRVL_QTY_2017').text(kora.common.format_comma(searchDtl.RTRVL_QTY_2017));
			...
			$('#RTRVL_QTY_SUM').text(kora.common.format_comma(searchDtl.RTRVL_QTY_SUM));
			...
			<div class="write_area">
				<div class="write_tbl">
					<table>
						...
						<tr>
							<th>2016년 <span class="tit" id="rtrvl_qty2_txt"></span></th>
							<td>
								<div class="row" style="text-align:right;">
									<div class="txtbox" id="RTRVL_QTY_2016" style="float:none;"></div>
								</div>
							</td>
						...
						<tr>
							<th>2017년 <span class="tit" id="rtrvl_qty2_txt"></span></th>
							<td>
								<div class="row" style="text-align:right;">
									<div class="txtbox" id="RTRVL_QTY_2017" style="float:none;"></div>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="row" style="text-align:right;">
									<div class="txtbox" id="RTRVL_QTY_SUM" style="float:none;"></div>
								</div>
							</td>
