...
<script type="text/javaScript" language="javascript" defer="defer">
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('				<DataGridColumn dataField="CRCT_WHSL_FEE_STAX" 	headerText="'+ parent.fn_text('stax')+ '" width="110" formatter="{numfmt}" id="num11" textAlign="right" />');//부가세
