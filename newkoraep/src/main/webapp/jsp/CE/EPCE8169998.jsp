...
$(document).ready(function(){
	...
	$("#btn_lst2").click(function(){
		location.href =   "/CE/EPCE8169901.do";
	});
...
fileNameOnChange = function(obj) {
	...
	<div class="iframe_inner">
		...
		<form name="fileForm" id="fileForm" method="post" enctype="multipart/form-data" action="/CE/EPCE8169998_09.do">
