	    	...
	    	var err_msg2 = "";
	    	 ...
	    	 for(var i=0; i<rtnData.length ;i++) {
	     	 ...
	     	 for(var i=0; i<rtnData.length ;i++) {
			    ...
			    input["WHSDL_BIZRNO"] = $('#WHSDL_BIZR').val().split(";")[1];
			    input["WHSDL_BRCH_NO"] = $('#WHSDL_BRCH').val().split(";")[1];
		     	...
		     	if(dup_cnt >0 && err_cnt >0){
		        	...
		        	alertMsg(err_msg+"\n등록 정보를 다시 확인해주시기 바랍니다.");
	     			...
	     			//도매업자 고정
					$('#WHSDL_BIZR').attr("disabled",true).attr("readonly",false);
					$('#WHSDL_BRCH').attr("disabled",true).attr("readonly",false);
	     		}
