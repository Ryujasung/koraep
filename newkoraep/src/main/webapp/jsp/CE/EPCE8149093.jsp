...
<div class="iframe_inner">
	...
	<section class="secwrap">
		...
		<div class="btnwrap mt20">
			<div class="fl_r">
			<c:if test="${userInfo.ATH_GRP_CD eq 'ATC002'or userInfo.ATH_GRP_CD eq 'ATH001' or userInfo.USER_ID eq notiInfo[0].REG_ID}">
			<button type="button" class="btn36 c1" style="width: 100px;" id="btn_upd">수정</button>
			<button type="button" class="btn36 c4" style="width: 100px;" id="btn_del">삭제</button>
			</c:if>
