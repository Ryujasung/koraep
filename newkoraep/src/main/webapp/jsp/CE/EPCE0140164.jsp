...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		//정보삭제
		function fn_del(){
			confirm("사용자정보를 삭제하시겠습니까? 삭제된 정보는 복구할 수 없습니다.", "fn_del_exec");
		}
		...
		function fn_pop(){
			...
			window.parent.NrvPub.AjaxPopup('/CE/EPCE0140188.do', pagedata);
		}
		...
		function fn_upd3(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/CE/EPCE0140164.do";
			kora.common.goPage('/CE/EPCE0140142.do', INQ_PARAMS);
		}
