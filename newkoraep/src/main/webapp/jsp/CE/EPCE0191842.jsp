...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	$(function() {
		...
		fn_btnSetting();
	     ...
	     $("#STD_FEE").val(INQ_PARAMS.PARAMS.STD_FEE);                    				//기준취급수수료         
	     $("#PSBL_ST_FEE").val(INQ_PARAMS.PARAMS.PSBL_ST_FEE);            				//조정 가능 최저 기준취급수수료    
	     $("#PSBL_END_FEE").val(INQ_PARAMS.PARAMS.PSBL_END_FEE);       			//조정 가능 최고 기준취급수수료    
	     $("#STD_WHSL_FEE").val(INQ_PARAMS.PARAMS.STD_WHSL_FEE);                 //기준도매수수료     
	     $("#PSBL_ST_WHSL_FEE").val(INQ_PARAMS.PARAMS.PSBL_ST_WHSL_FEE);     	//조정 가능 최저 기준도매수수료
	     $("#PSBL_END_WHSL_FEE").val(INQ_PARAMS.PARAMS.PSBL_END_WHSL_FEE);//조정 가능 최고 기준도매수수료    
	     $("#STD_RTL_FEE").val(INQ_PARAMS.PARAMS.STD_RTL_FEE);                   		//기준소매수수료         
	     $("#PSBL_ST_RTL_FEE").val(INQ_PARAMS.PARAMS.PSBL_ST_RTL_FEE);            //조정 가능 최저 기준소매수수료    
	     $("#PSBL_END_RTL_FEE").val(INQ_PARAMS.PARAMS.PSBL_END_RTL_FEE);		//조정 가능 최고 기준소매수수료    
	     ...
	     if(INQ_PARAMS.PARAMS.START_DT <= toDay){
			 ...
			 $("#STD_FEE").prop("disabled",true);
			 $("#STD_WHSL_FEE").prop("disabled",true);
			 $("#STD_RTL_FEE").prop("disabled",true);
			 flag = true;
		 } 
	...
	function fn_reg(){
			...
			//수수료 유효성 체크	
				...
				if( $("#STD_FEE").val() !=INQ_PARAMS.PARAMS.STD_FEE || $("#STD_RTL_FEE").val() !=INQ_PARAMS.PARAMS.STD_RTL_FEE 
					||$("#STD_WHSL_FEE").val() !=INQ_PARAMS.PARAMS.STD_WHSL_FEE || $("#START_DT").val().replace(/-/gi, "") !=INQ_PARAMS.PARAMS.START_DT ){
