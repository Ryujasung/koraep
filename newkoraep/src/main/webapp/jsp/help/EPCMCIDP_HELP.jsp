...
<div id="pop_wrap" class="help_wrap" style="width:870px; height:580px">
	...
	<div id="pop_container">
		<div class="pop contents bdB_none">
			<div class="helpBox">
				<p class="img"><img src="../../images/help/img_2_2.gif" alt=""></p>
				<div class="txtBox">
					<dl>
						<dt>1</dt>
						...
						<dt>3</dt>
						<dd>"도매업자" 클릭하면 상세현황을 조회 합니다.</dd>
						<!-- 2016-07-14 -->
						<dt>4</dt>
						<dd>오른쪽 하단 "증빙자료조회" 버튼을 클릭하여 소매 회수 증빙자료를 조회합니다.</dd>
						<!-- //2016-07-14 -->
					</dl>
				</div>					
			</div>
			...
			<div class="helpBox">
				<p class="img"><img src="../../images/help/img_2_2_1.gif" alt=""></p>
				<div class="txtBox">
					<dl>
						<dt>1</dt>
						<dd>상세현황을 조회 합니다.</dd>
