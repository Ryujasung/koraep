...
<div id="pop_wrap" class="help_wrap" style="width:870px; height:580px">
	...
	<div id="pop_container">
		<div class="pop contents bdB_none">
			<div class="helpBox">
				<p class="img"><img src="../../images/help/img_17_3.gif" alt=""></p>
				<div class="txtBox">
					<dl>
						<dt>1</dt>
						<dd>조회기간을 선택하고 "조회" 버튼을 클릭 하여 자료를 조회합니다.</dd>
						<dt>2</dt>
						<dd>"전체확장"을 클릭하여 전체 지역의 출고회수 현황을 조회합니다.</dd>
						<dt>3</dt>
						<dd>"지역명"을 클릭하여 각 지역의 출고회수 현황을 조회합니다.</dd>
					</dl>
				</div>
			</div>
		</div>
