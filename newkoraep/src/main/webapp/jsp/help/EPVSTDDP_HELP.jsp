...
<div id="pop_wrap" class="help_wrap" style="width:870px; height:580px">
	...
	<div id="pop_container">
		<div class="pop contents bdB_none">
			<div class="helpBox">
				<p class="img"><img src="../../images/help/img_4_4.gif" alt=""></p>
				<div class="txtBox">
					<dl>
						<dt>1</dt>
						<dd>
							조회조건을 선택하고 "조회" 버튼을 클릭 하여 자료를 조회합니다.<br>
							조회조건 중 상태는 "입고확인", "센터확인", "고지등록", "수납확인", "지급요청", "지급예정"이 선택가능합니다.
						</dd>
						<dt>2</dt>
						<dd>조회된 자료는 상단에 "엑셀저장" 버튼을 클릭하여 저장 가능합니다.</dd>
						<dt>3</dt>
						<dd>"등록일자"를 클릭하여 상세현황을 조회합니다.</dd>
					</dl>
				</div>
			</div>
		</div>
