...
<header id="header">
	...
	<button type="button" class="btn_alarm" onClick="alarmCntBtn_Click()"><span class="length alarmCntDiv" style="display:none;"><a href="#self" class="alarm" id="alarmCnt"></a></span><span class="hide">알람</span></button>
