...
#main .mainstat .stat {float: right;}
#main .mainstat .stat  dl {position: relative; box-sizing: border-box; width: 324px; height: 187px; margin: 7px 0 0; padding: 26px 23px 25px; border-radius: 5px; background: #ffffff; box-shadow: 5px 6px 0px 0px rgba(0, 0, 0, 0.32);}

#main .mainstat .stat  dl dt {margin: 0 0 33px; font-weight: 700; font-size: 18px; line-height: 24px; color: #363636;}
#main .mainstat .stat  dl dd {text-align: right;}
#main .mainstat .stat  dl dd .val {font-weight: 700; font-size: 56px; line-height: 56px; letter-spacing: -0.05em;}
#main .mainstat .stat  dl dd .unit {font-weight: 700; font-size: 14px; line-height: 16px; color: #545454;}
#main .mainstat .stat  dl.stat1 dd .val {color: #1d70ee;}
#main .mainstat .stat  dl.stat2 dd .val {color: #ff673d;}
#main .mainstat .stat  dl {transition: all .3s;}
#main .mainstat .stat  dl:hover {transform: translate(2px, 3px); box-shadow: none;}
			...
			<div id="main">
				<div class="mainstat">
					<div class="gree">
						...
						<div class="btns">
							<a id="EPCE01" href="/CE/EPCE0140101.do" pagetitle="회원관리" class="btn1">회원관리</a>
							<a id="EPCE01" href="/CE/EPCE0160101.do" pagetitle="사업자관리" class="btn2">사업자관리</a>
						</div>
					</div>
					<div class="stat">
