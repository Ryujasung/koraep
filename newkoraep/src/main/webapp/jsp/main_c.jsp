			...
			<div id="main">
				<div class="mainstat">
					<div class="gree">
						...
						<div class="btns">
							<a id="EPCE68" href="/CE/EPCE2924601.do" pagetitle="회수정보조회" class="btn1">회수정보조회</a>
							<a id="EPCE68" href="/CE/EPCE2910101.do" pagetitle="반환내역서작성/조회" class="btn2">반환내역서조회</a>
						</div>
					</div>
					<div class="stat" style="padding-top:187px">
