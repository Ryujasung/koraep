...
<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_upd4(){
			...
			var url = "/WH/EPWH0160117.do";//단체설정
		...
		function fn_upd5(){
		    ...
		    parent_item= input;
			var pagedata = window.frameElement.name;
			var url = "/WH/EPWH0181088.do";//지역설정
				window.parent.NrvPub.AjaxPopup(url, pagedata);
		}
		...
		//변경화면 이동
		function fn_upd(){
			INQ_PARAMS["URL_CALLBACK"] = "/WH/EPWH9000216.do";
			kora.common.goPage('/WH/EPWH9000242.do', INQ_PARAMS);
		}
		
		function fn_cnl(){		 
			//location.href = "/CE/EPCE9000201.do";		
			//kora.common.goPageB('', INQ_PARAMS);
			kora.common.goPage('/WH/EPWH9000201.do', INQ_PARAMS);
		}
