...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="CPCT_CD" headerText="용량(신구병)" textAlign="center" width="300" />');
			layoutStr.push('			<DataGridColumn dataField="PRPS_CD" headerText="용도" textAlign="center" width="300" />');//지역
