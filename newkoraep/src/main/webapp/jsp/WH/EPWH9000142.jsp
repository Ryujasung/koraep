					...
					<div class="srcharea"  id="divInput" > 
                           ...
                           <!--  <div class="row">
							...
							<div class="singleRow" style="float:right ">
									<div class="btn" id="CR">
										<button type="button" class="btn36 c5" style="width: 100px; margin-right: 5px; margin-bottom: 10px;" id="btn_reg2">변경</button>
									</div>
							</div>
					</div>  <!-- end of srcharea -->
					<!-- <div class="h4group" >
