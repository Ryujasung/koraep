...
<!-- 페이징 사용 등록 -->
	...
	$(document).ready(function(){
		...
		if( askSeq != ''){
			...
			//페이지이동
		    kora.common.goPageD(sAction, {"ASK_SEQ": askSeq, "CNTN_SE": "Q"}, {});
		}
		/*상세조회 바로이동*/
	...
	//목록
	function fn_lst(){		 
		location.href =   "/WH/EPWH8126601.do";		
	}
	...
	function gridSet(){
		...
		layoutStr.push('			<DataGridColumn dataField="SBJ" headerText="'+parent.fn_text('sbj')+'" width="54%" itemRenderer="HtmlItem" />');
		layoutStr.push('			<DataGridColumn dataField="USER_NM" headerText="'+parent.fn_text('reg_prsn')+'" textAlign="center" width="14%" />');
		layoutStr.push('			<DataGridColumn dataField="BIZRNM" headerText="'+parent.fn_text('bizr_nm')+'" textAlign="center" width="14%" />');
