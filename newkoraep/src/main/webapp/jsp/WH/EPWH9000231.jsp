...
// 		fn_btnSetting();
 		...
 		kora.common.setEtcCmBx2(whsdlList, "","", $("#WHSDL_BIZRNM"), "BIZRNO_DE", "BIZRNM", "N" ,'S');//도매업자 업체명
...
// 		if(!confirm("사업자관리 페이지로 이동하시겠습니까?")) return;
		...
		kora.common.goPageB('/WH/EPWH9000201.do', INQ_PARAMS);
	}
	...
	<div class="iframe_inner">
		...
		<div class="btnwrap">
			<div class="fl_r" id="BR">
 						<button type="button" class="btn36 c4" id="btn_cnl"style="width: 100px;">취소</button> 
