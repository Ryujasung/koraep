...
<script src="/js/kora/paging_common.js"></script>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_reg(){
			...
			INQ_PARAMS["URL_CALLBACK"] = "/WH/EPWH0140101.do";
			kora.common.goPage('/WH/EPWH8716231.do', INQ_PARAMS);
		}
		 ...
		 */
		 function fn_set_grid() {
			 ...
			 layoutStr.push('	<DataGridColumn dataField="MBIL_NO"  headerText="'+parent.fn_text('tel_no')+'" width="100"/>');
		...
		function fn_pop(){
			...
			window.parent.NrvPub.AjaxPopup('/WH/EPWH01401882.do', pagedata);
		}
