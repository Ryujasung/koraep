...
<script type="text/javaScript" language="javascript" defer="defer">
    ...
    function prpsCdCheck(){
     ...
     function fn_init(){
			...
			kora.common.setEtcCmBx2(whsdl_cd_list, "","", $("#WHSDL_BIZRNM"), "BIZRID_NO", "BIZRNM", "N");	//도매업자
			...
			<section class="secwrap" style="display:none">
				...
				<div class="row">
					    ...
					    <div class="col" style="width: 50%">
							...
							<div class="box">
								<input type="text" id="WHSDL_BIZRNO" style=""  disabled="disabled"/>
						...
						<div class="col">
							...
							<div class="box">
								<select  id="WHSDL_BRCH_NM" style=""  class="i_notnull"  ></select>
							</div>
						</div> 
					</div> <!-- end of row -->
				</div>
			...
			<section class="secwrap" >
					<div class="srcharea"  id="divInput" > 
							<div class="row">
								    ...
								    <div class="col">
										<div class="tit" id="ctnr_nm2_txt" style="width: 109px"></div>  <!-- 빈용기명(소매) -->
										<div class="box">
											<select id="RTRVL_CTNR_CD" style="" class="i_notnull" ></select>
										</div>
									</div>
							</div> <!-- end of row -->
							<div class="row">
									<div class="col">
										...
										<div class="box">
											<input type="text" id="RTRVL_QTY" style="text-align:right;"  format="minus" class="i_notnull" maxlength="8"/>
										</div>
									</div>
									<div class="col" style="">
										<div class="tit" id="rtl_fee2_txt" style="width: 109px"></div>  <!-- 소매수수료 -->
										<div class="box" style="" >
											<input type="text" id="REG_RTRVL_FEE" style="text-align:right;width: 179px" format="minus" class="i_notnull" maxlength="10" />
										</div>
									</div>
									<div class="col">
										<div class="tit" id="rmk_txt"></div>  <!-- 비고 -->
										<div class="box">
											  <input type="text" id="RMK" style="" maxByteLength="100"/>
										</div>
									</div>
							</div> <!-- end of row -->
							<div class="row">
									<div class="col">
										...
										<div class="box" id="CUST_SEL" style="width:169px">
									...
									<div class="col" id="cust_y">
										<div class="tit" id="whsdl" style="width: 109px"></div>  <!-- 회수처-->
										<div class="box">
