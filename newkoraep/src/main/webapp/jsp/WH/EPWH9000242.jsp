	...
	function fn_reg(){
		...
		if(bizrSecd == 'H'){
		 ...
		 if(kora.common.format_noComma(kora.common.null2void($("#RCS_NM").val(),0))  < 1) {
	            alertMsg("반환수집소명을(를) 입력하십시요.", "kora.common.cfrmDivChkValid_focus");
	            chkTarget = $("#RCS_NM");
	            return;
	        } 	
		 ...
		 if(kora.common.format_noComma(kora.common.null2void($("#LOC_GOV").val(),0))  < 1) {
	            alertMsg("관리지자체을(를) 입력하십시요.", "kora.common.cfrmDivChkValid_focus");
	            chkTarget = $("#LOC_GOV");
	            
	            return;
	        } 
		 if(kora.common.format_noComma(kora.common.null2void($("#LOC_NM").val(),0))  < 1) {
	            alertMsg("담당자을(를) 입력하십시요.", "kora.common.cfrmDivChkValid_focus");
	            chkTarget = $("#LOC_NM");
		 ...
		 if(kora.common.format_noComma(kora.common.null2void($("#LOC_HTEL").val(),0))  < 1) {
	            alertMsg("담당자 핸드폰번호을(를) 입력하십시요.", "kora.common.cfrmDivChkValid_focus");
	            chkTarget = $("#LOC_HTEL");
...
// 		if(!confirm("사업자관리 페이지로 이동하시겠습니까?")) return;
		...
		kora.common.goPageB('/WH/EPWH9000216.do', INQ_PARAMS);
	}
	...
	function fn_acctCheck(){
		...
		var url   = "/WH/ACCT_NM_CHECK.do";		//예금주명체크
		               ...
		               <!--  <div class="row" >
		                ...
		                <div  class="row"  style="width: 100%;font-size: 16pt; font-weight: bold;text-align:left;background-color: #f0f0f0;">관리업체 정보</div>
		                 <div class="row"   id="ma3">
		                    <div class="col"  style="width: 100%">
		                        ...
		                        <div class="box">
		                        	<input type="text" id="WHSDL_BIZRNM" name="WHSDL_BIZRNM" style="width: 330px;" class="i_notnull"  readonly >
		                        </div>
		                    </div>
		                </div> <!-- end of row -->
		                ...
		                <div class="row"   id="ma4" style="display: none;">
		                    <div class="col"  style="width: 100%">
		                        ...
		                        <div class="box">
		                        	<input type="text" id="WHSDL_BIZRNO" name="WHSDL_BIZRNO" style="width: 330px;" class="i_notnull"   readonly  >
		                        </div>
		                    </div>
		                </div> <!-- end of row -->
