...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);// 그리드 loading bar off
	...
	layoutStrChart.push('             <Column3DSeries labelPosition="outside" yField="PRPS0" displayName="유흥용" outsideLabelYOffset="-10"  showValueLabels="[]" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                  <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
	layoutStrChart.push('            <Column3DSeries labelPosition="outside" yField="PRPS1" displayName="가정용" outsideLabelYOffset="-10"  showValueLabels="[]" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
	//layoutStrChart.push('            <Column3DSeries labelPosition="outside" yField="PRPS2" displayName="직접반환하는자용" outsideLabelYOffset="-10" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	//layoutStrChart.push('                  <showDataEffect>');
	//layoutStrChart.push('                     <SeriesInterpolate/>');
	//layoutStrChart.push('                </showDataEffect>');
	//layoutStrChart.push('            </Column3DSeries>');
