	...
	//저장 확인
 	 ...
 	 */
 	 function fnSetGrid1(reDrawYn) {
 			...
 			layoutStr.push('			<DataGridColumn dataField="BIZRNO_DE" headerText="'+ parent.fn_text('bizrno')+ '"	width="190"  textAlign="center" 	  />');							//총괄직매장
 			layoutStr.push('			<DataGridColumn dataField="BRCH_NM"	headerText="'+ parent.fn_text('brch')+ '" 	width="190"  textAlign="left"		  />'); 							//직매장
			   	...
			   	<div class="layer_body">		
						...
						<section class="btnwrap mt20"  >
							...
							<div class="btn" style="float:right">
								<button type="button" class="btn36 c1" style="width: 100px;" id="btn_cnl">취소</button>
