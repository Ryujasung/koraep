...
<!--                                     <div class="emp">활동 / 비활동 / 수기 / (지급지점)</div> -->
                  ...
                  <!--   <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <input type="text" id="ACP_ACCT_DPSTR_NM" name="ACP_ACCT_DPSTR_NM" value="이상휘" style="width: 179px;" >
                                <button type="button" id="chk2" class="btn34 c6" style="width: 92px;">예금주 확인</button>
                                <div class="chkbox" style="padding-top:8px">
                                    <label class="chk">
                                        <input type="checkbox" id="ACCT_CHECK_YN" name="ACCT_CHECK_YN" checked><span></span>
                                    </label>
                                </div>
                            </div>
                        </td>
