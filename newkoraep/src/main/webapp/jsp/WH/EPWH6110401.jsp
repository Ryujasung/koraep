...
// 				hideLoadingBar(); 
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="WHSDL_BIZRNM" visible="false" headerText="'+ parent.fn_text('whsdl')+ '" width="150" textAlign="center"  />');//도매업자
			layoutStr.push('			<DataGridColumn dataField="AREA" visible="false" headerText="'+ parent.fn_text('area')+ '" width="100" 	textAlign="center"  />');//지역
			...
			layoutStr.push('			<DataGridColumn dataField="QTY_TOT" headerText="'+ parent.fn_text('lst_wrhs_qty')+ '" 	width="150" 	textAlign="right" 	   formatter="{numfmt}" id="num1" />');	//입고량
			layoutStr.push('			<DataGridColumn dataField="CRCT_QTY_TOT" headerText="'+ parent.fn_text('crct_cfm_qty')+ '" 	width="150" 	textAlign="right" 	   formatter="{numfmt}" id="num2" />');	//입고량
			layoutStr.push('		</groupedColumns>');
...
/****************************************** 그리드 셋팅 끝***************************************** */
	...
	layoutStrChart.push('             <Column3DSeries labelPosition="outside" yField="FB_CFM_QTY_TOT" displayName="유흥용" outsideLabelYOffset="-10" showValueLabels="[]" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                  <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
	layoutStrChart.push('            <Column3DSeries labelPosition="outside" yField="FH_CFM_QTY_TOT" displayName="가정용" outsideLabelYOffset="-10" showValueLabels="[]" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
	layoutStrChart.push('            <Column3DSeries labelPosition="outside" yField="DRCT_CFM_QTY_TOT" displayName="직접반환하는자용" outsideLabelYOffset="-10" showValueLabels="[]" showTotalLabel="true" halfWidthOffset="0" itemRenderer="CylinderItemRenderer">');
	layoutStrChart.push('                  <showDataEffect>');
	layoutStrChart.push('                     <SeriesInterpolate/>');
	layoutStrChart.push('                </showDataEffect>');
	layoutStrChart.push('            </Column3DSeries>');
