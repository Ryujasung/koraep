...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	function fn_pop(){
		...
		window.parent.NrvPub.AjaxPopup('/WH/EPWH6172488.do', pagedata);
	}
    
    function fn_page(){
    
		INQ_PARAMS["URL_CALLBACK"] = "/WH/EPWH6172401.do";
		kora.common.goPage('/WH/EPWH61724012.do', INQ_PARAMS);
    ...
    function fn_page2(){
		...
		INQ_PARAMS["URL_CALLBACK"] = "/WH/EPWH6172401.do";
		kora.common.goPage('/WH/EPWH6172442.do', INQ_PARAMS);
     ...
     function fn_whsl_se_cd(){
		...
		var input ={};
		   ...
		   if( $("#MFC_BIZRNM").val() !="" ){
       	   ...
       	   ajaxPost(url, input, function(rtnData) {
   				if ("" != rtnData && null != rtnData) {  
   					 kora.common.setEtcCmBx2(rtnData, "","", $("#WHSDL_BIZRNM"), "CUST_BIZRID_NO", "CUST_BIZRNM", "N"); //도매업자 업체명 
   				}else{
   					alertMsg("error");
   				}
    		});
...
// 			kora.common.hideLoadingBar(dataGrid, gridRoot);
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="AREA_NM" headerText="'+ parent.fn_text('area')+ '" id="tmp1" width="100"/>');
			layoutStr.push('			<DataGridColumn dataField="CTNR_USE_YN" headerText="'+ parent.fn_text('aplc_yn')+ '" id="tmp2" width="100"/>');
			layoutStr.push('		</groupedColumns>');
