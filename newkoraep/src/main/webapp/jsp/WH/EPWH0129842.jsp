...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		var upDeptCdList = ${upDeptCdList};	//상위부서
				...
				<input type="hidden" id="BIZRNO" name="BIZRNO"/>
					<table>
						...
						<tr>
							...
							<td>
								<div class="row">
									<input type="text" id="DEPT_LVL" name="DEPT_LVL" style="width: 179px;border:0px" readonly class="i_notnull" maxLength="2" format="number" >
								</div>
							</td>
						</tr>
						<tr>
