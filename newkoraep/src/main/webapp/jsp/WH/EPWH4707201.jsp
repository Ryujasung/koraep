...
<%@include file="/jsp/include/common_page.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_pop(){
			...
			window.parent.NrvPub.AjaxPopup('/WH/EPWH4707288.do', pagedata);
		}
		 ...
		 */
		 function fn_set_grid() {
             ...
             layoutStr.push('   <DataGridColumn dataField="EXCA_ISSU_SE_NM" id="tmp1" headerText="'+parent.fn_text('exca_issu_se')+'" width="100" />');
             layoutStr.push('   <DataGridColumn dataField="EXCA_SE_NM" id="tmp2" headerText="'+parent.fn_text('exca_se')+'" width="100" />');
             layoutStr.push('   <DataGridColumn dataField="EXCA_PROC_STAT_NM" id="tmp3" headerText="'+parent.fn_text('stat')+'" width="100" itemRenderer="HtmlItem" />');
