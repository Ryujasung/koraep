...
<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_upd6(){
			...
			var item = {};
			item.BIZRNM = searchDtl.BIZRNM;
			item.GRP_BRCH_NM = searchDtl.GRP_BRCH_NM;
			item.BRCH_NM = searchDtl.BRCH_NM;
			item.BRCH_NO = searchDtl.BRCH_NO;
			item.BRCH_ID = searchDtl.BRCH_ID;
			item.BIZRNO = searchDtl.BIZRNO;
			item.BIZRID = searchDtl.BIZRID;
			...
			var url = "/WH/EPWH55990088.do";//지역설정
		...
		function fn_upd5(){
		    ...
		    parent_item= input;
			var pagedata = window.frameElement.name;
			var url = "/WH/EPWH55990013.do";//단체설정
			window.parent.NrvPub.AjaxPopup(url, pagedata);
		}
		...
		//변경화면 이동
		function fn_upd(){
			INQ_PARAMS["URL_CALLBACK"] = "/WH/EPWH55990012.do";
			kora.common.goPage('/WH/EPWH55990422.do', INQ_PARAMS);
		}
		...
		/**
		 ...
		 function fnSetDtlData(data){
			...
			$("#AFF_OGN_NM").text(kora.common.null2void(data.AFF_OGN_NM));
			...
			$('#AREA_NM').text(kora.common.null2void(data.AREA_NM));
		...
		<div class="write_area">
			...
			<form name="frmMenu" id="frmMenu" method="post" >
				<table>
					...
					<tr>
						<th colspan="2" id="aff_ogn_nm">소속단체</th>
						<td>
							<div class="row">
								<div class="txtbox" id="AFF_OGN_NM"></div> &nbsp;
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th class="bd_l" id="tel_no3">대표 휴대폰번호</th>
						<td>
							<div class="row">
					...
					<tr>
						<th colspan="2" id="alt_req_stat_cd">지역</th>
						<td>
							<div class="row">
								<div class="txtbox" id="AREA_NM"></div>
							</div>
						</td>
					</tr>
					<tr>
