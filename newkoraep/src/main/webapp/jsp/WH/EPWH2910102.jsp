...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   //변경 페이지 이동 
 	function fn_upd() {
		...
		INQ_PARAMS["URL_CALLBACK"] = "/WH/EPWH2910102.do";
   ...
   function fn_del(){
	 ...
	 */
	 function fnSetGrid1(reDrawYn) {
			...
			layoutStr.push('			<DataGridColumn dataField="PRPS_CD" headerText="'+ parent.fn_text('prps_cd')+ '"  textAlign="center" width="100"  />');//용도
			...
			layoutStr.push('				<DataGridColumn dataField="BOX_QTY" headerText="'+ parent.fn_text('box_qty')+ '" width="80" formatter="{numfmt}" textAlign="right" id="num1" />');//상자
			layoutStr.push('				<DataGridColumn dataField="RTN_QTY"	headerText="'+ parent.fn_text('btl')+ '" width="80" formatter="{numfmt}" textAlign="right" id="num2" />');//병
			...
			layoutStr.push('			<DataGridColumn dataField="REAL_PAY_DT" headerText="'+parent.fn_text('real_pay_dt')+'" width="100" id="tmp4" textAlign="center"/>');//지급일시
			layoutStr.push('			<DataGridColumn dataField="CFM_QTY" headerText="'+ parent.fn_text('wrhs_qty')+ '" width="80" formatter="{numfmt}" id="num11" textAlign="right" />');//입고량
