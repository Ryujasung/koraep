...
/* 		$("#RCS_NM").change(function(){
	 ...
	 */
	 function fn_set_grid() {
		 ...
		 layoutStr.push('	<DataGridColumn dataField="RCS_NO" visible="false"  headerText="순번" textAlign="center" width="50"   draggable="false"/>');
...
<!-- 셀렉트박스 부분 -->
				...
				<div class="row">
					<div class="col">
				 	...
				 	<div class="col">
						...
						<div class="box">
								<select id="WHSDL_BIZRNM" name="WHSDL_BIZRNM" style="width: 300px; "  disabled="disabled"></select>
						</div>  
					</div>  
		...
		<section class="btnwrap" >
			<div class="btnwrap">
				...
				<button type="button" class="btn36 c2" style="width: 123px; margin-top: 10px; " id="btn_reg">수집소정보등록</button>
				</div>
