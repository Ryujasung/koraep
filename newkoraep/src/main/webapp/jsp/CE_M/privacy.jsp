...
/* 	$("#btn_prev1").click(function(){	//이전 개인정보처리방침
	...
	$("#btn_prev6").click(function(){	//이전 개인정보처리방침
		$(".layer_close").trigger("click");
		NrvPub.AjaxPopup('/jsp/privacy_200803.jsp');
	});
	
	$("#btn_prev7").click(function(){	//이전 개인정보처리방침
		$(".layer_close").trigger("click");
		NrvPub.AjaxPopup('/jsp/privacy_210310.jsp');
	});	 */
...
<body>
	<div class="layer_popup"><!-- style="width:722px;" -->
		...
		<div class="layer_body" style="overflow-y:scroll;"><!-- height:450px; -->
			<div class="terms_wrap">
				<div class="terms_date">
					<span>2021. 6. 10. 시행</span>
				</div>
                <div class="terms_body">
                    ...
                    <div>
                        ...
                        <p>보증금센터는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</p>
                        <table>
                            <colgroup>
                                <col style="width:30%">
                                <col style="width:70%">
                    ...
                    <div>
                        ...
                        <ol>
                            <li>1) 개인정보보호 책임자 : 제도혁신부문장</li>
                            <li>•성명 : 여수호 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •메일 : sonykj98@cosmo.or.kr</li>
                            <li>•전화번호 : 02-2071-7132 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •Fax : 02-2071-7170</li>
                            <li>2) 개인정보보호 담당자 : 운영관리팀장</li>
                            <li>•성명 : 윤성섭 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •부서 : 운영관리팀 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •메일 : ssyoon@cosmo.or.kr</li>
                            <li>•전화번호 : 02-2071-7154 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •Fax : 02-2071-7170</li>
                        </ol>
                    </div>
                    <div>
                        ...
                        <!-- <p> - 이전의 개인정보처리방침은 아래에서 확인할 수 있습니다.</p> -->
   						...
   						<p style="color:#1d70ee;"><a class="" id="btn_prev6" style="cursor: pointer;">•2020.3.10. ~ 2020.8.03. 적용 이전의 개인정보처리방침</a></p>
   						<p style="color:#1d70ee;"><a class="" id="btn_prev7" style="cursor: pointer;">•2020.8.03. ~ 2021.3.10. 적용 이전의 개인정보처리방침</a></p> -->
                    </div>
                    <!-- <div>
                        <p class="tit">[부칙]</p>
