...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	$(function() {
		...
		var bizrTpCdOri = "<c:out value='${BIZR_TP_CD_ORI}' />";
		if(bizrTpCdOri == 'W1'){
			$('[name="linkBtnW1"]').show();
			$('#topBanner1').show();
			//$('#mainBanner1').show();
	...
	<div id="wrap" class="topbannerClose">
		...
		<div class="hd_outer">
			...
			<div id="sub_gnb" class="sub_gnb">
				<ul style="width: 100%;">
					<li class="i1" style="display:none" id="topBanner1"><a id="EPWH92" href="/WH/EPWH2925801.do" pagetitle="회수정보관리"><span class="cate">회수정보관리</span></a></li>
					<!-- <li class="i2"><a id="EPWH29" href="/WH/EPWH2910131.do" pagetitle="반환내역서작성/조회"><span class="cate">반환내역서등록</span></a></li> -->
					<li class="i2"><a id="EPWH92" href="/WH/EPWH2910101.do" pagetitle="반환내역서작성/조회"><span class="cate">반환내역서작성/조회</span></a></li>
					<li class="i4"><a id="EPWH92" href="/WH/EPWH2983901.do" pagetitle="생산자입고확인"><span class="cate">생산자입고확인</span></a></li>
					<li class="i5"><a id="EPWH62" href="/WH/EPWH2371301.do" pagetitle="입금내역조회"><span class="cate">입금내역조회</span></a></li>
					<!-- <li class="i6"><a href="#self"><span class="cate">구병출고대비반환</span></a></li> -->
				</ul>
			</div>
			...
			<div id="main">
				<div class="mainstat">
					<div class="gree">
						...
						<div class="btns">
							<a id="EPWH81" href="/WH/EPWH8149001.do" pagetitle="공지사항" class="btn1">공지사항</a>
							
							<a id="EPWH81" href="/WH/EPWH8126601.do" pagetitle="문의/답변" class="btn2" name="linkBtnW2" style="display:none">문의/답변</a>
							<a id="EPWH62" href="/WH/EPWH6186401.do" pagetitle="회수대비초과반환현황" class="btn2" name="linkBtnW1" style="display:none">회수대비초과반환현황</a>
							
						</div>
					</div>
					<div class="stat">
						<a id="EPWH92" href="/WH/EPWH2983901.do" pagetitle="생산자입고확인">
						<dl class="stat1">
							<dt>생산자입고확인(전일)</dt>
							<dd>
						...
						<a id="EPWH62" href="/WH/EPWH2371301.do" pagetitle="입금내역조회">
						<dl class="stat2">
							<dt>입금내역(전일)</dt>
							<dd>
				...
				<div class="mainsect">
					<div class="hgroup">
						<div class="tit">MY<strong>알림</strong></div>
					</div>
					<div class="content">
						<div class="main_tbl">
							<div class="title">공지사항<br><a id="EPWH81" href="/WH/EPWH8149001.do" pagetitle="공지사항" class="more">more</a></div>
							<table >
								<colgroup>
									<col style="width: 75%;">
						...
						<div class="main_tbl" >
							<div class="title">입고정정확인<br><a id="EPWH47" href="/WH/EPWH4704201.do" pagetitle="입고정정확인" class="more">more</a></div>
							<table>
								<colgroup>
									<col style="width: 50%;">
									<col style="width: 25%;">
								...
								<tbody id="CFM_CRCT_LIST">
								</tbody>
							</table>
						</div>
					</div>
				</div>
				<div class="mainsect" id="mainBanner1" style="display:none">
					<div class="hgroup">
					...
					<div class="content">
						<div class="main_guide">
							<ul>
								<li class="g1">
									<a id="EPWH29" href="/WH/EPWH2925801.do" pagetitle="회수정보관리" >
										<div class="tit">회수정보조회하기</div>
										<div class="btn"><span>메뉴얼보기</span></div>
									</a>
								</li>
								<li class="g3">
									<a id="EPWH29" href="/WH/EPWH2910101.do" pagetitle="반환내역서작성/조회">
										<div class="tit">반환내역서등록하기</div>
										<div class="btn"><span>메뉴얼보기</span></div>
									</a>
								</li>
								<li class="g4">
									<a id="EPWH29" href="/WH/EPWH2983901.do" pagetitle="생산자입고확인">
										<div class="tit">입고정보조회하기</div>
										<div class="btn"><span>메뉴얼보기</span></div>
									</a>
								</li>
								<li class="g2">
									<a id="EPWH62" href="/WH/EPWH6110401.do" pagetitle="생산자입고확인현황">
										<div class="tit">생산자입고확인현황조회하기</div>
										<div class="btn"><span>메뉴얼보기</span></div>
									</a>
								</li>
								<li class="g6">
									<a id="EPWH62" href="/WH/EPWH2371301.do" pagetitle="입금내역조회">
										<div class="tit">입금내역조회하기</div>
										<div class="btn"><span>메뉴얼보기</span></div>
									</a>
								</li>
								<li class="g5">
									<a id="EPWH47" href="/WH/EPWH4704201.do" pagetitle="입고정정확인">
