...
<%@include file="/jsp/include/common_page_m.jsp" %>
	...
	<script type="text/javaScript" language="javascript" defer="defer">
		...
		function fn_page2(){
			kora.common.goPageB('/RT/EPRT9071301.do', INQ_PARAMS);
		}
		 ...
		 function gridReadyHandler(id) {
			...
			function searchListMake(){
				...
				$.each(searchList, function(i,v){
					...
					html += '	<tbody>';
					html += '		<tr>';
					html += '			<th colspan="2">입고확인일</th>';
					html += '			<td colspan="6">'+kora.common.formatter.datetime(v.WRHS_CFM_DT, "yyyy-mm-dd")+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">생산자</th>';
					html += '			<td colspan="6">'+v.MFC_BIZRNM+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">직매장/공장</th>';
					html += '			<td colspan="6">'+v.MFC_BRCH_NM+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">입고량</th>';
					html += '			<td colspan="6">'+kora.common.format_comma(v.WRHS_QTY)+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">보증금(원)</th>';
					html += '			<td colspan="6">'+kora.common.format_comma(v.WRHS_GTN)+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">수수료(원)</th>';
					html += '			<td colspan="6">'+kora.common.format_comma(v.FEE)+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">부가세(원)</th>';
					html += '			<td colspan="6">'+kora.common.format_comma(v.FEE_STAX)+'</td>';
					html += '		</tr>';
					html += '		<tr>';
					html += '			<th colspan="2">소계(원)</th>';
					html += '			<td colspan="6">'+kora.common.format_comma(v.TOT)+'</td>';
					html += '		</tr>';
					html += '	</tbody>';
					html += '</table>';
					html += '<br>';
