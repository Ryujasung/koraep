...
import egovframework.mapper.ce.ep.EPCE9000101Mapper;
 ...
 *
 */  
@Service("EPCE9000101Service")   
public class EPCE9000101Service {   
	
	@Resource(name="EPCE9000101Mapper")
	private EPCE9000101Mapper EPCE9000101Mapper; //회수정보관리 Mapper
	 ...
	 * @  
	 */
	  public ModelMap EPCE9000101_select(ModelMap model, HttpServletRequest request) {
			...
			String   title					= commonceService.getMenuTitle("EPCE9000101");						//타이틀
			...
			try {
					...
					List<?>	pbox_bizr_list = pbox_bizr_select(request, map);    			//도매업자 업체명조회
					...
					model.addAttribute("pbox_bizr_list", util.mapToJson(pbox_bizr_list));
	  ...
	  /**   
		 ...
		 * @  
		 */
		  public void  EPCE9000101_add(ModelMap model, HttpServletRequest request) {
				...
				try {
					Map<String, String> paramMap = util.jsonToMap(jParams.getJSONObject("SEL_PARAMS"));
					map.put("WHSDL_BIZRNO", paramMap.get("WHSDL_BIZRNO"));	
					EPCE9000101Mapper.pbox_add(map);    			//도매업자 업체명조회
				}catch (IOException io) {
					System.out.println(io.toString());
				}catch (SQLException sq) {
					System.out.println(sq.toString());
		  ...
		  public void  EPCE9000101_del(ModelMap model, HttpServletRequest request) {
				...
				try {
					Map<String, String> paramMap = util.jsonToMap(jParams.getJSONObject("SEL_PARAMS"));
					map.put("WHSDL_BIZRNO", paramMap.get("WHSDL_BIZRNO"));	
					EPCE9000101Mapper.pbox_delete(map);    			//도매업자 업체명조회
				}catch (IOException io) {
					System.out.println(io.toString());
				}catch (SQLException sq) {
					System.out.println(sq.toString());
		  ...
		  /**
			...
			public List<?> pbox_bizr_select(HttpServletRequest request, Map<String, String> data)  {
				...
				//로그인자가 도매업자 일경우
					selList = EPCE9000101Mapper.pbox_bizr_select((HashMap<String, String>) map);
		 ...
		 * @
		 */
		public HashMap EPCE9000101_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap EPCE9000101_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		try {
		 ...
		 * @
		 */
		public HashMap EPCE9000101_select4(Map<String, Object> inputMap, HttpServletRequest request) {
	    		...
	    		try {
					rtnMap.put("selList", util.mapToJson(EPCE9000101Mapper.EPCE9000101_select(inputMap))); 
//					rtnMap.put("totalList", util.mapToJson(EPCE9000101Mapper.EPCE9000101_select_cnt(inputMap)));
//					rtnMap.put("amt_tot_list", util.mapToJson(EPCE9000101Mapper.EPCE9000101_select2(inputMap))); 
				}catch (IOException io) {
					System.out.println(io.toString());
				}catch (SQLException sq) {
					System.out.println(sq.toString());
		 ...
		 * @
		 */
		public String EPCE9000101_excel(HashMap<String, Object> data, HttpServletRequest request) {
			...
			String errCd = "0000";
			try {
				List<?> list = EPCE9000101Mapper.EPCE9000101_select(data);
		 ...
		 * @
		 */
		public String EPCE9000101_delete(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
			String errCd = "0000";
			...
			if (list != null) {
				try {
					for (int i = 0; i < list.size(); i++) {
						...
						/*int stat = EPCE9000101Mapper.EPCE9000101_select3(map); // 상태 체크
						if (stat > 0) {
							throw new Exception("A012"); // 상태정보가 변경되어있습니다. 다시 한 번 확인하시기 바랍니다.
						}*/
						EPCE9000101Mapper.EPCE9000101_delete(map); //  삭제
					}
		 ...
		 * @
		 */
		public String EPCE9000101_update(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			List<?> list = JSONArray.fromObject(inputMap.get("list"));
			HttpSession session = request.getSession();
			...
			if (list != null) {     
				try {     
					for(int i=0; i<list.size(); i++){
						 ...
						 EPCE9000101Mapper.EPCE9000101_update(map);
					}       
				}catch (IOException io) {
					System.out.println(io.toString());
				}catch (SQLException sq) {
...
************************************************************************************************************************************************/
		 ...
		 * @
		 */   
		  public ModelMap EPCE9000164_select(ModelMap model, HttpServletRequest request) {
			  
			  	//파라메터 정보
				String reqParams = util.null2void(request.getParameter("INQ_PARAMS"),"{}");
				JSONObject jParams = JSONObject.fromObject(reqParams);
				Map<String, String> map = util.jsonToMap(jParams.getJSONObject("PARAMS"));
				List<?>	initList 			= EPCE9000101Mapper.EPCE9000142_select(map);    	//상세 그리드 값   
				String   title					= commonceService.getMenuTitle("EPCE9000164");		//타이틀
  ...
  ************************************************************************************************************************************************/
	 ...
	 * @
	 */
	  public ModelMap EPCE9000131_select(ModelMap model, HttpServletRequest request) {
		      
		  	//파라메터 정보   
			String reqParams 				= util.null2void(request.getParameter("INQ_PARAMS"),"{}");
			JSONObject jParams 			= JSONObject.fromObject(reqParams);
			Map<String, String> map 		= new HashMap<String, String>();
			String   	title						= commonceService.getMenuTitle("EPCE9000131");	//타이틀
			List<?>	whsdl_cd_list 			= commonceService.whsdl_select(map);    				//도매업자 업체명조회
			//List<?>	pbox_bizr_list = pbox_bizr_select(request, map);    			//도매업자 업체명조회
			List<?> stat_cd_list		= commonceService.getCommonCdListNew("S200");						//상태
		 ...
		 * @
		 */
		public HashMap EPCE9000131_select2(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
  		try {
		 ...
		 * @
		 */
		public HashMap EPCE9000131_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
  		try {
  				rtnMap.put("dps_fee_list", util.mapToJson(commonceService.rtrvl_ctnr_dps_fee_select(inputMap))); 	//회수용기 보증금 취급수수료
			}catch (IOException io) {
		 ...
		 * @
		 */
		public HashMap EPCE9000131_select4(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
  		try {  
  				rtnMap.put("selList", util.mapToJson(EPCE9000101Mapper.EPCE9000131_select4(inputMap))); 	
			}catch (IOException io) {
				System.out.println(io.toString());
			}catch (SQLException sq) {
				System.out.println(sq.toString());
		 ...
		 * @
		 */
		public HashMap EPCE9000131_select5(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	    	...
	    	try {  
  				rtnMap.put("selList", util.mapToJson(EPCE9000101Mapper.EPCE9000131_select5(inputMap))); 	
			}catch (IOException io) {
				System.out.println(io.toString());
			}catch (SQLException sq) {
				System.out.println(sq.toString());
		...
		public String EPCE9000131_insert(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
				HttpSession session = request.getSession();
				UserVO vo = (UserVO) session.getAttribute("userSession");
				String errCd = "0000";
				...
				if (list != null) {
					try {
						for(int i=0; i<list.size(); i++){
							...
							int sel = EPCE9000101Mapper.EPCE9000131_chk(map); //중복체크
							if(sel>0){  
						 	...
						 	EPCE9000101Mapper.EPCE9000131_insert2(map); 					// 회수상세
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @          
 	 */  
 	  public ModelMap EPCE9000142_select(ModelMap model, HttpServletRequest request) {
			...
			String   	title						= commonceService.getMenuTitle("EPCE9000142");	//타이틀
			List<?>	whsdl_cd_list 			= commonceService.whsdl_select(map);    				//도매업자 업체명조회
			List<?> stat_cd_list		= commonceService.getCommonCdListNew("S200");						//상태
			List<?> AreaCdList = commonceService.getCommonCdListNew("B010");
			map.put("WORK_SE", "4"); 																				//업무구분 1.출고 ,2.직접회수 ,3.교환 ,4.회수 , 5.반환
...
//					model.addAttribute("INQ_PARAMS",jParams);
 	 ...
 	 /**
		 ...
		 */       
	    @Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
		public String EPCE9000142_update(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
				HttpSession session = request.getSession();
				UserVO vo = (UserVO) session.getAttribute("userSession");
				String errCd = "0000";
				String ssUserId  = "";   //사용자ID     
				...
				if (list != null) {                      
					try {
						...
						for(int i=0; i<list.size(); i++){
								...
								/*int sel = EPCE9000101Mapper.EPCE9000131_select2(map); //중복체크       
								if(sel>0){
								...
								//map.put("SDT_DT", map.get("RTRVL_DT"));	//등록일자제한설정  등록일자 1.DLIVY_DT,2.DRCT_RTRVL_DT, 3.EXCH_DT, 4.RTRVL_DT, 5.RTN_DT
							 	...
							 	/*if(!keyCheck){   
							 			EPCE9000101Mapper.EPCE9000142_delete(map); 	// info삭제
								 		list2.add(map);
								 		keyCheck = true;   
								 		if(map.get("ADJ").equals("T")){
									 			if(map.get("RTRVL_STAT_CD").equals("RG") || map.get("RTRVL_STAT_CD").equals("WG") || map.get("RTRVL_STAT_CD").equals("RJ") || map.get("RTRVL_STAT_CD").equals("WJ") ){								 				
												 			...
												 			EPCE9000101Mapper.EPCE90001422_update(map); //회수조정일경우 마스터 상태값 변경
									 			}
								 		}//end of if(map.get("ADJ").equals("T"))
							 	}//end of if(!keyCheck)
*/							 	//detail
							 	EPCE9000101Mapper.EPCE9000142_update(map); // 회수상세
						}//end of for  
						
						//마스터 등록 length 길이만큼   회수량, 수수료 SUM update
					 	/*for(int j=0 ;j<list2.size(); j++){
					 		Map<String, String> map3 = (Map<String, String>) list2.get(j);
//					 		EPCE9000101Mapper.EPCE9000131_update(map3);
					 	}*/
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @     
 	 */     
 	  public ModelMap EPCE90001422_select(ModelMap model, HttpServletRequest request) {
 		        
 			//파라메터 정보
			String reqParams = util.null2void(request.getParameter("INQ_PARAMS"),"{}");      
			JSONObject jParams = JSONObject.fromObject(reqParams);    
			Map<String, String> map = util.jsonToMap(jParams.getJSONObject("PARAMS"));   
			String   title					= commonceService.getMenuTitle("EPCE90001422");		//타이틀   
			List<?>	initList 			= EPCE9000101Mapper.EPCE9000142_select(map);    	//상세 그리드 값   
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @
 	 */  
 	  public ModelMap EPCE9000197_select(ModelMap model, HttpServletRequest request) {
 		      
 		  	//파라메터 정보
 			String reqParams 			= util.null2void(request.getParameter("INQ_PARAMS"),"{}");
 			JSONObject jParams 		= JSONObject.fromObject(reqParams);   
 			Map<String, String> map = new HashMap<String, String>();
 			String   title						= commonceService.getMenuTitle("EPCE9000197");		//타이틀  
 			List<?>	whsdl_cd_list 		= commonceService.whsdl_select(map);    					//도매업자 업체명조회
 			try {
 				model.addAttribute("whsdl_cd_list", util.mapToJson(whsdl_cd_list));	   
 				model.addAttribute("INQ_PARAMS",jParams);
		 ...
		 * @
		 */   
		public HashMap EPCE9000197_select2(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
			...
			if(vo != null ){
	    		...
	    		try {
					rtnMap.put("selList", util.mapToJson(EPCE9000101Mapper.EPCE9000197_select(inputMap))); 
				}catch (IOException io) {
					System.out.println(io.toString());
				}catch (SQLException sq) {
					System.out.println(sq.toString());
		 ...
		 * @    
		 */    
		public String EPCE9000197_delete(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
			String errCd = "0000";
				try {  
						EPCE9000101Mapper.EPCE9000197_delete(inputMap); //  삭제  
				}catch (IOException io) {
					System.out.println(io.toString());
				}catch (SQLException sq) {
					System.out.println(sq.toString());
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @  
 	 */     
 	  public ModelMap EPCE9000188_select(ModelMap model, HttpServletRequest request) {
 		     
 		  	//파라메터 정보   
 			String reqParams 			= util.null2void(request.getParameter("INQ_PARAMS"),"{}");
 			JSONObject jParams 		= JSONObject.fromObject(reqParams);
 			Map<String, String> map = new HashMap<String, String>();
 			String   title						= commonceService.getMenuTitle("EPCE9000188");		//타이틀
 			try {
 				model.addAttribute("INQ_PARAMS",jParams);   
 				model.addAttribute("titleSub", title);
 			}catch (IOException io) {
 	 ...
 	 /**
		 ...
		 */
	    @Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
		public String EPCE9000188_insert(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
	    	HttpSession session = request.getSession();
			UserVO vo = (UserVO)session.getAttribute("userSession");
...
*/		    
 ...
 /***********************************************************************************************************************************************
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @          
 	 */
 	  public ModelMap EPCE90001882_select(@RequestParam Map<String, Object> param, ModelMap model, HttpServletRequest request) {
			...
			if(vo != null ){
 			...
 			List<?>	initList 			= EPCE9000101Mapper.EPCE9000197_select (param); 
 			String   	title				= commonceService.getMenuTitle("EPCE90001882");		//타이틀
 			try {
 				model.addAttribute("initList", util.mapToJson(initList));	   
 				model.addAttribute("INQ_PARAMS",jParams);  
 				model.addAttribute("titleSub", title);
