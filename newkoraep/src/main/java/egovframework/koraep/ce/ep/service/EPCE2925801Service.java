 ...
 *
 */  
@Service("epce2925801Service")   
public class EPCE2925801Service {   
	
	@Resource(name="epce2925801Mapper")
	private EPCE2925801Mapper epce2925801Mapper; //회수정보관리 Mapper
	 ...
	 * @  
	 */
	  public ModelMap epce2925801_select(ModelMap model, HttpServletRequest request) {
			...
			String   title					= commonceService.getMenuTitle("EPCE2925801");						//타이틀
		 ...
		 * @
		 */
		public HashMap epce2925801_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap epce2925801_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		try {
		 ...
		 * @
		 */
		public HashMap epce2925801_select4(Map<String, Object> inputMap, HttpServletRequest request) {
	    		...
	    		try {
					rtnMap.put("selList", util.mapToJson(epce2925801Mapper.epce2925801_select(inputMap))); 
					rtnMap.put("totalList", util.mapToJson(epce2925801Mapper.epce2925801_select_cnt(inputMap)));
					rtnMap.put("amt_tot_list", util.mapToJson(epce2925801Mapper.epce2925801_select2(inputMap))); 
				} catch (Exception e) {
					// TODO Auto-generated catch block
					org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
				}	  
		 ...
		 * @
		 */
		public String epce2925801_excel(HashMap<String, Object> data, HttpServletRequest request) {
			...
			String errCd = "0000";
			try {
				List<?> list = epce2925801Mapper.epce2925801_select(data);
		 ...
		 * @
		 */
		public String epce2925801_delete(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
			String errCd = "0000";
			...
			if (list != null) {
				try {
					for (int i = 0; i < list.size(); i++) {
						...
						int stat = epce2925801Mapper.epce2925801_select3(map); // 상태 체크
						if (stat > 0) {
							throw new Exception("A012"); // 상태정보가 변경되어있습니다. 다시 한 번 확인하시기 바랍니다.
						}
						epce2925801Mapper.epce2925801_delete(map); //  삭제
					}
		 ...
		 * @
		 */
		public String epce2925801_update(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			List<?> list = JSONArray.fromObject(inputMap.get("list"));
			HttpSession session = request.getSession();
			...
			if (list != null) {     
				try {     
					for(int i=0; i<list.size(); i++){
						 ...
						 epce2925801Mapper.epce2925801_update(map);
					}       
				}catch (Exception e) {
					 if(e.getMessage().equals("A012")){
						 throw new Exception(e.getMessage());
...
************************************************************************************************************************************************/
		 ...
		 * @
		 */   
		  public ModelMap epce2925864_select(ModelMap model, HttpServletRequest request) {
			  
			  	//파라메터 정보
				String reqParams = util.null2void(request.getParameter("INQ_PARAMS"),"{}");
				JSONObject jParams = JSONObject.fromObject(reqParams);
				Map<String, String> map = util.jsonToMap(jParams.getJSONObject("PARAMS"));
				List<?>	initList 			= epce2925801Mapper.epce2925842_select(map);    	//상세 그리드 값   
				String   title					= commonceService.getMenuTitle("EPCE2925864");		//타이틀
				try {
  ...
  ************************************************************************************************************************************************/
	 ...
	 * @
	 */
	  public ModelMap epce2925831_select(ModelMap model, HttpServletRequest request) {
		      
		  	//파라메터 정보   
			String reqParams 				= util.null2void(request.getParameter("INQ_PARAMS"),"{}");
			JSONObject jParams 			= JSONObject.fromObject(reqParams);
			Map<String, String> map 		= new HashMap<String, String>();
			String   	title						= commonceService.getMenuTitle("EPCE2925831");	//타이틀
		 ...
		 * @
		 */
		public HashMap epce2925831_select2(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
  		try {
		 ...
		 * @
		 */
		public HashMap epce2925831_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
  		try {
  				rtnMap.put("dps_fee_list", util.mapToJson(commonceService.rtrvl_ctnr_dps_fee_select(inputMap))); 	//회수용기 보증금 취급수수료
			} catch (Exception e) {
		 ...
		 * @
		 */
		public HashMap epce2925831_select4(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
  		try {  
  				  
  				Map<String, String> map = epce2925801Mapper.epce2925831_select3(inputMap);
  				inputMap.put("WHSDL_BRCH_ID", map.get("BRCH_ID"));		//도매업자지점 아이디
  				inputMap.put("WHSDL_BRCH_NM", map.get("BRCH_NM"));	//도매업자 지점이름
  			    
  				rtnMap.put("selList", util.mapToJson(epce2925801Mapper.epce2925831_select4(inputMap))); 	
			} catch (Exception e) {
				// TODO Auto-generated catch block
				org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
			}	  
		 ...
		 * @
		 */
		public HashMap epce2925831_select5(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	    	...
	    	try {  
  				rtnMap.put("selList", util.mapToJson(epce2925801Mapper.epce2925831_select5(inputMap))); 	
			} catch (Exception e) {
				// TODO Auto-generated catch block
				org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
			}	  
		...
		public String epce2925831_insert(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
				HttpSession session = request.getSession();
				UserVO vo = (UserVO) session.getAttribute("userSession");
				String errCd = "0000";
				...
				if (list != null) {
					try {
						...
						for(int i=0; i<list.size(); i++){
							...
							checkMap = epce2925801Mapper.epce2925831_select(map); //소매정보 조회
							...
							if(checkMap !=null) {
								if(!checkMap.get("BIZRID").equals("") && !checkMap.get("BRCH_ID").equals("N") ){ //사업자, 지점 둘다 등록상태
									...
									epce0121801Mapper.epce0121831_insert2(checkMap); //소매 지점등록
								...
								epce0121801Mapper.epce0121831_insert(checkMap); 	//소매 사업자등록
								epce0121801Mapper.epce0121831_insert2(checkMap); 	//소매 지점등록
							...
							int sel = epce2925801Mapper.epce2925831_select2(map); //중복체크
							...
							String rtrvl_stat_cd = epce2925801Mapper.epce2925801_select4(map); //회수등록구분
							...
							map.put("RTRVL_STAT_CD", rtrvl_stat_cd);	//회수상태코드          
						 	...
						 	if(!keyCheck){        
									...
									epce2925801Mapper.epce2925831_insert(map); 					// 회수마스터  등록
							 		list2.add(map);
						 	}	
						 	//detail
						 	epce2925801Mapper.epce2925831_insert2(map); 					// 회수상세
						...
						//마스터 등록 length 길이만큼   회수량, 수수료 SUM update
					 	for(int j=0 ;j<list2.size(); j++){
					 		...
					 		epce2925801Mapper.epce2925831_update(map);
					 	}     
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @          
 	 */  
 	  public ModelMap epce2925842_select(ModelMap model, HttpServletRequest request) {
 	 ...
 	 /**
		 ...
		 */       
	    @Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
		public String epce2925842_insert(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
				HttpSession session = request.getSession();
				UserVO vo = (UserVO) session.getAttribute("userSession");
				String errCd = "0000";
				String ssUserId  = "";   //사용자ID     
					...
					try {
						...
						for(int i=0; i<list.size(); i++){
								...
								if(sel !=1){
							 	...
							 	if(!keyCheck){   
							 			epce2925801Mapper.epce2925842_delete(map); 	// info삭제
								 		list2.add(map);
								 		keyCheck = true;   
								 		if(map.get("ADJ").equals("T")){
									 			if(map.get("RTRVL_STAT_CD").equals("RG") || map.get("RTRVL_STAT_CD").equals("WG") || map.get("RTRVL_STAT_CD").equals("RJ") || map.get("RTRVL_STAT_CD").equals("WJ") ){								 				
												 			...
												 			epce2925801Mapper.epce29258422_update(map); //회수조정일경우 마스터 상태값 변경
									 			}
						...
						//마스터 등록 length 길이만큼   회수량, 수수료 SUM update
					 	for(int j=0 ;j<list2.size(); j++){
					 		...
					 		epce2925801Mapper.epce2925831_update(map3);
					 	}
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @     
 	 */     
 	  public ModelMap epce29258422_select(ModelMap model, HttpServletRequest request) {
 		        
 			//파라메터 정보
			String reqParams = util.null2void(request.getParameter("INQ_PARAMS"),"{}");      
			JSONObject jParams = JSONObject.fromObject(reqParams);    
			Map<String, String> map = util.jsonToMap(jParams.getJSONObject("PARAMS"));   
			String   title					= commonceService.getMenuTitle("EPCE29258422");		//타이틀   
			List<?>	initList 			= epce2925801Mapper.epce2925842_select(map);    	//상세 그리드 값   
			map.put("BIZRID", map.get("WHSDL_BIZRID"));
 			map.put("BIZRNO", map.get("WHSDL_BIZRNO"));
 			List<?>	brch_nmList 	= commonceService.brch_nm_select(request, map);   			 	//도매업자지점
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @
 	 */  
 	  public ModelMap epce2925897_select(ModelMap model, HttpServletRequest request) {
 		      
 		  	//파라메터 정보
 			String reqParams 			= util.null2void(request.getParameter("INQ_PARAMS"),"{}");
 			JSONObject jParams 		= JSONObject.fromObject(reqParams);   
 			Map<String, String> map = new HashMap<String, String>();
 			String   title						= commonceService.getMenuTitle("EPCE2925897");		//타이틀  
 			List<?>	whsdl_cd_list 		= commonceService.whsdl_select(map);    					//도매업자 업체명조회
 			try {
 				model.addAttribute("whsdl_cd_list", util.mapToJson(whsdl_cd_list));	   
 				model.addAttribute("INQ_PARAMS",jParams);
		 ...
		 * @
		 */   
		public HashMap epce2925897_select2(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
			...
			if(vo != null ){
	    		...
	    		try {
					rtnMap.put("selList", util.mapToJson(epce2925801Mapper.epce2925897_select(inputMap))); 
				} catch (Exception e) {
					// TODO Auto-generated catch block
					org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
				}	  
		 ...
		 * @    
		 */    
		public String epce2925897_delete(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
			String errCd = "0000";
				try {  
						epce2925801Mapper.epce2925897_delete(inputMap); //  삭제  
				} catch (Exception e) {
						 throw new Exception("A001"); // DB 처리중 오류가 발생하였습니다. 관리자에게 문의하세요.
				}    
			return errCd;  
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @  
 	 */     
 	  public ModelMap epce2925888_select(ModelMap model, HttpServletRequest request) {
 		     
 		  	//파라메터 정보   
 			String reqParams 			= util.null2void(request.getParameter("INQ_PARAMS"),"{}");
 			JSONObject jParams 		= JSONObject.fromObject(reqParams);
 			Map<String, String> map = new HashMap<String, String>();
 			String   title						= commonceService.getMenuTitle("EPCE2925888");		//타이틀
 			try {
 				model.addAttribute("INQ_PARAMS",jParams);   
 				model.addAttribute("titleSub", title);
 			} catch (Exception e) {
 	 ...
 	 /**
		 ...
		 */
	    @Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
		public String epce2925888_insert(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
	    	HttpSession session = request.getSession();
			UserVO vo = (UserVO)session.getAttribute("userSession");
			...
			try {	
					while (fileIter.hasNext()) {
						...
						if(fileName != null && !fileName.equals("")){
							...
							epce2925801Mapper.epce2925888_insert(inputMap);	
						}
					}
...
*/		    
 ...
 /***********************************************************************************************************************************************
   ...
   ************************************************************************************************************************************************/
 	 ...
 	 * @          
 	 */
 	  public ModelMap epce29258882_select(@RequestParam Map<String, Object> param, ModelMap model, HttpServletRequest request) {
			...
			if(vo != null ){
 			...
 			List<?>	initList 			= epce2925801Mapper.epce2925897_select (param); 
 			String   	title				= commonceService.getMenuTitle("EPCE29258882");		//타이틀
 			try {
 				model.addAttribute("initList", util.mapToJson(initList));	   
 				model.addAttribute("INQ_PARAMS",jParams);  
 				model.addAttribute("titleSub", title);
