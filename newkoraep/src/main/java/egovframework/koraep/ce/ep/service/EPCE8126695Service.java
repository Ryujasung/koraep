...
import egovframework.mapper.ce.ep.EPCE8126695Mapper;
 ...
 *
 */
@Service("epce8126695Service")
public class EPCE8126695Service {
	
	@Resource(name="epce8149093Mapper")
	private EPCE8149093Mapper epce8149093Mapper;
	
	@Resource(name="epce8126695Mapper")
	private EPCE8126695Mapper epce8126695Mapper;
	 ...
	 * @
	 */
	public ModelMap epce8126695(ModelMap model, HttpServletRequest request)  {
		
		String title = commonceService.getMenuTitle("EPCE8126695");	//타이틀
		...
		//공지사항 상세조회
		List<?> askInfo = epce8126695Mapper.epce8126695_select1(map);
		...
		List<?> ansrInfo = epce8126695Mapper.epce8126695_select2(map);
		if(null == ansrInfo) {
	 ...
	 */
	@Transactional
	public int epce8126695_delete(Map<String, String> data, HttpServletRequest request)  {
		
		int result = 0;
		
		result += epce8126695Mapper.epce8126695_delete(data);
