...
import egovframework.mapper.ce.ep.EPCE6657001Mapper;
 ...
 *
 */
@Service("epce6657001Service")
public class EPCE6657001Service {
	
	@Resource(name="epce6657001Mapper")
	private EPCE6657001Mapper epce6657001Mapper;
	 ...
	 * @
	 */
	  public ModelMap epce6657001_select(ModelMap model, HttpServletRequest request) {
	   ...
	   * @
	   */
  	  public HashMap<String, Object> epce6657001_select2(Map<String, Object> data) {

			HashMap<String, Object> map = new HashMap<String, Object>();
			
			List<?> list = epce6657001Mapper.epce6657001_select(data);
			try {
			...
			map.put("totalList", epce6657001Mapper.epce6657001_select_cnt(data));
			
			return map;
  	  }
  	  
  	public String epce6657001_excel(HashMap<String, Object> data, HttpServletRequest request) {
