 ...
 *
 */
@Service("epce2910101Service")
public class EPCE2910101Service {


	@Resource(name="epce2910101Mapper")
	private EPCE2910101Mapper epce2910101Mapper;  //반환관리 Mapper
	 ...
	 * @
	 */
	  public ModelMap epce2910101_select(ModelMap model, HttpServletRequest request) {
			...
			String   title					= commonceService.getMenuTitle("EPCE2910101");		//타이틀
			List<?>	whsdlList 		=commonceService.mfc_bizrnm_select4(request, map);    			//도매업자 업체명조회
			List<?> grid_info			= commonceService.GRID_INFO_SELECT("EPCE2910101",request);		//그리드컬럼 조회
	  ...
	  /**
		 ...
		 * @
		 */
		  public ModelMap epce2910101_select_1(ModelMap model, HttpServletRequest request) {
				...
				List<?> sys_seList		= commonceService.getCommonCdListNew("S004");		//등록구분
				List<?> areaList			= commonceService.getCommonCdListNew("B010");		//지역
				String   title					= commonceService.getMenuTitle("EPCE2910102");		//타이틀
				List<?>	whsdlList 		=commonceService.mfc_bizrnm_select4(request, map);    			//도매업자 업체명조회
				List<?> grid_info			= commonceService.GRID_INFO_SELECT("EPCE2910101",request);		//그리드컬럼 조회
		 ...
		 * @
		 */
		public HashMap epce2910101_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap epce2910101_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		try {
		 ...
		 * @
		 */
		public HashMap epce2910101_select4(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		 ...
		 * @
		 */
		public HashMap epce2910101_select5(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		 ...
		 * @
		 */
		public HashMap epce2910101_select5_1(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		 ...
		 * @
		 */
		public String epce2910101_excel(HashMap<String, Object> data, HttpServletRequest request) {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
			...
			String errCd = "0000";
			try {
				List<?> list = epce2910101Mapper.epce2910101_select4(data);
		 ...
		 * @
		 */
		public String epce2910102_excel(HashMap<String, Object> data, HttpServletRequest request) {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
			...
			String errCd = "0000";
			try {
				List<?> list = epce2910101Mapper.epce2910101_select4_1(data);
		 ...
		 * @
		 */
		public String epce2910164_excel(HashMap<String, String> data, HttpServletRequest request) {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
			...
			String errCd = "0000";
			try {
				List<?> list = epce2910101Mapper.epce2910164_select2(data);
		 ...
		 * @
		 */
		public String epce2910101_delete(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
			String errCd = "0000";
			...
			if (list != null) {
				try {
					for (int i = 0; i < list.size(); i++) {
						...
						int stat = epce2910101Mapper.epce2910101_select6(map); // 상태 체크
						if (stat > 0) {
		 ...
		 * @
		 */
		public String epce2910101_update(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			List<?> list = JSONArray.fromObject(inputMap.get("list"));
			HttpSession session = request.getSession();
			...
			if (list != null) {
				try {
					for(int i=0; i<list.size(); i++){
						...
						int stat = epce2910101Mapper.epce2910101_select5(map); //상태 체크
						 if(stat>0){
						...
						epce2910101Mapper.epce2910101_insert(map); 		//실태조사요청정보 테이블에 등록
		 ...
		 * @
		 */
		public String epce2910101_update2(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			List<?> list = JSONArray.fromObject(inputMap.get("list"));
			HttpSession session = request.getSession();
			...
			if (list != null) {
				try {
					for(int i=0; i<list.size(); i++){
						...
						int stat = epce2910101Mapper.epce2910101_select7(map); //상태 체크
		 ...
		 * @
		 */
		  public ModelMap epce2910164_select(ModelMap model, HttpServletRequest request) {
			  	HttpSession session = request.getSession();
				UserVO vo = (UserVO)session.getAttribute("userSession");
				...
				String title = commonceService.getMenuTitle("EPCE2910164");		//타이틀
				List<?> iniList = epce2910101Mapper.epce2910164_select(map);		//상세내역 조회
				List<?> gridList = epce2910101Mapper.epce2910164_select2(map);		//그리드쪽 조회
