...
import egovframework.mapper.ce.ep.EPCE2924601Mapper;
 ...
 *
 */  
@Service("epce2924601Service")   
public class EPCE2924601Service {   
	
	@Resource(name="epce2924601Mapper")
	private EPCE2924601Mapper epce2924601Mapper; //회수정보조회 Mapper
	 ...
	 * @  
	 */
	  public ModelMap epce2924601_select(ModelMap model, HttpServletRequest request) {
			...
			String   title					= commonceService.getMenuTitle("EPCE2924601");						//타이틀
		 ...
		 * @
		 */
		public HashMap epce2924601_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap epce2924601_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		try {    			
		 ...
		 * @
		 */
		public HashMap epce2924601_select4(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	    		try {	    			
					...
					rtnMap.put("selList", util.mapToJson(epce2924601Mapper.epce2924601_select(inputMap))); 
					System.out.println("rtnMap"+rtnMap);
					rtnMap.put("totalList", util.mapToJson(epce2924601Mapper.epce2924601_select_cnt(inputMap)));
//					System.out.println("rtnMap"+rtnMap);
					//rtnMap.put("amt_tot_list", util.mapToJson(epce2924601Mapper.epce2924601_select2(inputMap))); 
				} catch (Exception e) {
					// TODO Auto-generated catch block
					org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
				}	  
		 ...
		 * @
		 */
		public String epce2924601_excel(HashMap<String, Object> data, HttpServletRequest request) {
			...
			try {
				...
				List<?> list = epce2924601Mapper.epce2924601_select(data);
