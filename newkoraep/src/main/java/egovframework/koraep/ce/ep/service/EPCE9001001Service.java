...
import egovframework.mapper.ce.ep.EPCE9001001Mapper;
 ...
 *
 */
@Service("EPCE9001001Service")
public class EPCE9001001Service {  
	
	
	@Resource(name="EPCE9001001Mapper")
	private EPCE9001001Mapper EPCE9001001Mapper;  //회수대비초과반환현황 Mapper
	 ...
	 * @
	 */
	  public ModelMap EPCE9001001_select(ModelMap model, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap EPCE9001001_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap EPCE9001001_select3(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		...
    		try {
    			...
    			if( inputMap.get("CHART_YN") !=null && inputMap.get("CHART_YN").equals("Y")  ){
    				System.out.println("real?");
	    	  		rtnMap.put("selList_chart", util.mapToJson(EPCE9001001Mapper.epce9001001_select2(inputMap)));	  
	    	  	}
				rtnMap.put("selList", util.mapToJson(EPCE9001001Mapper.epce9001001_select(inputMap)));
			} catch (Exception e) {
				// TODO Auto-generated catch block
			}	  
	    	return rtnMap;    	
		 ...
		 * @
		 */
		public String EPCE9001001_excel(HashMap<String, Object> data, HttpServletRequest request) {
			...
			try {
				...
				List<?> list = EPCE9001001Mapper.epce9001001_select(data);
