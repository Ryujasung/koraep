...
@Controller
public class EPCE0140101Controller {
	 ...
	 * @
	 */
	@RequestMapping(value="/CE/EPCE0140101.do")
	public String epce0140101(ModelMap model, HttpServletRequest request) {
		
		model = epce0140101Service.epce0140101_select(model, request);
		
		return "/CE/EPCE0140101";
	}
	 ...
	 * @
	 */
	@RequestMapping(value="/CE/EPCE0140101_19.do", produces="text/plain;charset=UTF-8")
	@ResponseBody
	public String epce0140101_select(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
		
		return util.mapToJson(epce0140101Service.epce0140101_select2(data, request)).toString();
	}
	 ...
	 * @
	 */
	@RequestMapping(value="/CE/EPCE0140101_05.do")
	@ResponseBody
	public String epce0140101_excel(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
	 ...
	 * @
	 */
	@RequestMapping(value="/CE/EPCE0140101_21.do", produces="text/plain;charset=UTF-8")
	@ResponseBody
	public String epce3978301_update(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
		...
		try{
			if(data.get("gGubn").equals("A")){
				errCd = epce0140101Service.epce0140101_update(data, request); //회원복원
			}else if(data.get("gGubn").equals("B")){
				errCd = epce0140101Service.epce0140101_update2(data, request); //관리자변경
			}else if(data.get("gGubn").equals("C")){
				errCd = epce0140101Service.epce0140101_update(data, request); //비활동처리
			}else if(data.get("gGubn").equals("D")){
				errCd = epce0140101Service.epce0140101_update3(data, request); //비밀번호변경승인
	...
	public String epce0140188(ModelMap model, HttpServletRequest request) {
		...
		model = epce0140101Service.epce0140188_select(model);
	...
	public String epce0140188_select(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
		return util.mapToJson(epce0140101Service.epce0140188_select2(data)).toString();
	}
	...
	public String epce0140188_select2(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
		return util.mapToJson(epce0140101Service.epce0140188_select3(data)).toString();
	}
	...
	public String epce01401882(ModelMap model, HttpServletRequest request) {
		...
		model = epce0140101Service.epce01401882_select(model);
	...
	public String epce01401882_select(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
		return util.mapToJson(epce0140101Service.epce01401882_select2(data)).toString();
	}
	...
	public String epce0140164(ModelMap model, HttpServletRequest request) {
		...
		HashMap<String, String> privacyMap = util.jsonToMap(jParams.getJSONObject("SEL_PARAMS"));
		...
		privacyMap.put("PARAM_MENU_CD", "EPCE0140164");
		commonceService.insertPrivacy(request,model,privacyMap);
		return returnUrl;
	}
	...
	public String epce0140164_select(@RequestParam HashMap<String, String> data, ModelMap model, HttpServletRequest request) {
		return util.mapToJson(epce0140101Service.epce0140164_select2(data)).toString();
	}
