...
import egovframework.mapper.ce.ep.EPCE8126601Mapper;
 ...
 *
 */
@Service("epce8126601Service")
public class EPCE8126601Service {
	
	@Resource(name="epce8126601Mapper")
	private EPCE8126601Mapper epce8126601Mapper;
	 ...
	 * @
	 */
	public ModelMap epce8126601(ModelMap model, HttpServletRequest request)  {
		...
		//문의/답변 총 게시글 수 조회
		List<?> totalCnt = epce8126601Mapper.epce8126601(map);
	 ...
	 * @
	 */
	public HashMap<String, Object> epce8126601_select(Map<String, String> data, HttpServletRequest request)  {
		...
		//문의/답변 검색 게시글 수 조회
		List<?> totalCnt = epce8126601Mapper.epce8126601(data);
		
		//문의/답변 조회
		List<?> list = epce8126601Mapper.epce8126601_select(data);
