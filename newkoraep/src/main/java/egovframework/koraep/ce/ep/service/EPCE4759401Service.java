...
import egovframework.mapper.ce.ep.EPCE4759401Mapper;
 ...
 *
 */
@Service("epce4759401Service")
public class EPCE4759401Service {

	@Resource(name="epce4759401Mapper")
	private EPCE4759401Mapper epce4759401Mapper;
	 ...
	 * @
	 */
	public ModelMap epce4759401_select(ModelMap model, HttpServletRequest request) {
	 ...
	 * @
	 */
	public ModelMap epce4759431_select(ModelMap model, HttpServletRequest request) {
		...
		try {
			...
			model.addAttribute("titleSub", commonceService.getMenuTitle("EPCE4759431")); //타이틀
		} catch (Exception e) {
			// TODO Auto-generated catch block
			org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
		}
	 ...
	 * @
	 */
	public ModelMap epce4759442_select(ModelMap model, HttpServletRequest request) {
		...
		Map<String, String> map = new HashMap<String, String>();
		model.addAttribute("titleSub", commonceService.getMenuTitle("EPCE4759442")); //타이틀
		...
		List<?> ctnrList = epce6652931Mapper.epce6652931_select5(map);
		...
		try {
			...
			model.addAttribute("searchDtl", util.mapToJson(epce4759401Mapper.epce4759442_select(param)));
	 ...
	 * @
	 */
	public HashMap<String, Object> epce4759401_select2(Map<String, String> data) {
		...
		List<?> list = epce4759401Mapper.epce4759401_select(data);

		HashMap<String, Object> map = new HashMap<String, Object>();
		try {
			map.put("searchList", util.mapToJson(list));
			map.put("totalList", epce4759401Mapper.epce4759401_select_cnt(data));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
		}
	 ...
	 * @
	 */
	public HashMap<String, Object> epce4759401_select3(Map<String, String> data, HttpServletRequest request) {
	 ...
	 * @
	 */
	public HashMap<String, Object> epce4759401_select4(Map<String, String> inputMap, HttpServletRequest request) {
	 ...
	 * @
	 */
	public HashMap<String, Object> epce4759401_select5(Map<String, String> data, HttpServletRequest request) {
	 ...
	 * @
	 */
	public String epce4759401_excel(HashMap<String, String> data, HttpServletRequest request) {
	...
	public String epce4759431_update(Map<String, Object> inputMap, HttpServletRequest request) throws Exception  {
			...
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					if(map.get("CUST_SEL_CK").equals("Y")){
						...
						//존재하는지 체크
						Map<String, String> checkMap = (Map<String, String>) epce6652931Mapper.epce6652931_select7(map);
						...
						if(checkMap != null && !checkMap.get("CUST_BIZRID").equals("") && !checkMap.get("CUST_BRCH_ID").equals("N") 
							...
							if(checkMap == null || (checkMap != null && checkMap.get("CUST_BIZRID").equals("")) ){ 
								...
								epce6652931Mapper.epce6652931_insert(map); //소매 사업자등록
								epce6652931Mapper.epce6652931_insert2(map); //소매 지점등록
					...
					/*정산기간 진행 체크*/
					int sel2 = epce4759401Mapper.epce4759431_select2(map); //
					if(sel2 < 1){
						 throw new Exception("A017");
					}
					
					/*중복체크*/
					int sel = epce4759401Mapper.epce4759431_select(map); //
					if(sel > 0){
					...
					epce4759401Mapper.epce4759431_insert(map); //출고정정 등록
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	public String epce4759442_update(Map<String, Object> inputMap, HttpServletRequest request) throws Exception  {
		HttpSession session = request.getSession();
		UserVO vo = (UserVO) session.getAttribute("userSession");
		String errCd = "0000";
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					epce4759401Mapper.epce4759442_update(map); //출고정정 수정
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	public String epce4759401_delete(Map<String, Object> inputMap, HttpServletRequest request) throws Exception{
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					epce4759401Mapper.epce4759401_delete(map); //출고정정 삭제
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	public String epce4759401_update(Map<String, Object> inputMap, HttpServletRequest request) throws Exception{
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					epce4759401Mapper.epce4759401_update(map); //출고정정 수정
