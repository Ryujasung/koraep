 ...
 *
 */
@Service("epce6652931Service")
public class EPCE6652931Service {
	 ...
	 * @
	 */
	public ModelMap epce6652931_select1(ModelMap model, HttpServletRequest request)  {
		...
		try {
			...
			String   title		= commonceService.getMenuTitle("EPCE6652931");	//타이틀
	...
	public String epce6652931_update(Map<String, Object> inputMap, HttpServletRequest request) throws Exception  {
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					/*중복체크*/
					int sel = epce6652931Mapper.epce6652931_select6(map); //
					if(sel>0){
					...
					/*중복체크*/
				 	...
				 	if(!keyCheck){
						 ...
						 epce6652931Mapper.epce6652931_update1(map); 			// 출고마스터 등록
				 		 list2.add(map);
				 	}	
				 	...
				 	//detail
				 	epce6652931Mapper.epce6652931_update2(map); 		// 출고상세 등록
				 	
				}//end of for
				
			 	for(int j=0 ;j<list2.size(); j++){
			 		Map<String, String> map = (Map<String, String>) list2.get(j);
			 		epce6652931Mapper.epce6652931_update3(map);
			 	}
	 ...
	 * @
	 */
	public HashMap<String, Object> epce6652931_select2(Map<String, String> data, HttpServletRequest request)  {
	 ...
	 * @
	 */
	public HashMap epce6652931_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	...
	    	if(null != inputMap){
	            ...
	            if(bizr_tp_cd == null || bizr_tp_cd.equals("")){
	            	...
	            	if(bizr_tp_cd.equals("M2")){
			         ...
			         //빈용기명 조회
			       	 rtnMap.put("ctnr_nm", util.mapToJson(epce6652931Mapper.epce6652931_select5(inputMap)));
	            }
	         }
    	} catch (Exception e) {
			// TODO Auto-generated catch block
	...
	/**
	 * 출고생산자 선택 시, 직매장/공장, 도매업자 콤보박스 호출
	 * @param inputMap
	 * @param request
	 * @return
	 * @
	 */
	public HashMap epce6652931_select4(Map<String, String> inputMap, HttpServletRequest request) {
    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	 ...
	 * @
	 */
	public HashMap epce6652931_select5(Map<String, String> inputMap, HttpServletRequest request) {
    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    	try {
			rtnMap.put("ctnr_nm", util.mapToJson(epce6652931Mapper.epce6652931_select5(inputMap)));
		} catch (Exception e) {
	 ...
	 * @
	 */
	public HashMap epce6652931_select6(Map<String, String> inputMap, HttpServletRequest request) {
    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    	try {
			rtnMap.put("selList", util.mapToJson(epce6652931Mapper.epce6652931_select8(inputMap)));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
		}    	 
	 ...
	 * @
	 */
	public HashMap epce6652931_select7(Map<String, String> inputMap, HttpServletRequest request) {
    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
