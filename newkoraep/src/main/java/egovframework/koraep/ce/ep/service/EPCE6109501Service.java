...
import egovframework.mapper.ce.ep.EPCE6109501Mapper;
 ...
 *
 */
@Service("epce6109501Service")
public class EPCE6109501Service {

	@Resource(name="epce6109501Mapper")
	private EPCE6109501Mapper epce6109501Mapper;
	 ...
	 * @
	 */
	  public ModelMap epce6109501_select(ModelMap model, HttpServletRequest request) {
	   ...
	   * @
	   */
  	  public HashMap<String, Object> epce6109501_select2(Map<String, Object> data, HttpServletRequest request) {
			...
			try {
				List<?> list = epce6109501Mapper.epce6109501_select(data);
				map.put("searchList", util.mapToJson(list));

				if(data.get("CHART_YN") != null && data.get("CHART_YN").equals("Y")){
					List<?> list2 = epce6109501Mapper.epce6109501_select2(data);
					map.put("searchList2", util.mapToJson(list2));
				}

				map.put("totalList", epce6109501Mapper.epce6109501_select_cnt(data));
	  ...
	  /**
		 ...
		 * @
		 */
		public HashMap epce6109501_select3(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public String epce6109501_excel(HashMap<String, Object> data, HttpServletRequest request) {
