...
import egovframework.mapper.ce.ep.EPCE9000301Mapper;
 ...
 *
 */
@Service("epce9000301Service")
public class EPCE9000301Service {


	@Resource(name="epce9000301Mapper")
	private EPCE9000301Mapper epce9000301Mapper;  //반환관리 Mapper
	 ...
	 * @
	 */
	  public ModelMap epce9000301_select(ModelMap model, HttpServletRequest request) {
			...
			List<?> whsdlList = whsdlList(request, map);
	  ...
	  /**
		 ...
		 * @
		 */
		  public ModelMap epce9000301_select_1(ModelMap model, HttpServletRequest request) {
				...
				List<?> sys_seList		= commonceService.getCommonCdListNew("S004");		//등록구분
				List<?> areaList			= commonceService.getCommonCdListNew("B010");		//지역
				String   title					= commonceService.getMenuTitle("EPCE9000302");		//타이틀
				List<?>	whsdlList 		=commonceService.mfc_bizrnm_select4(request, map);    			//도매업자 업체명조회
				List<?> grid_info			= commonceService.GRID_INFO_SELECT("EPCE9000301",request);		//그리드컬럼 조회
		 ...
		 * @
		 */
		public HashMap epce9000301_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap epce9000301_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		try {
		 ...
		 * @
		 */
		public HashMap epce9000301_select4(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		...
		/**
	 	 ...
	 	 * @          
	 	 */  
	 	  public ModelMap epce9000342_select(ModelMap model, HttpServletRequest request) {
...
//	 				model.addAttribute("initList", util.mapToJson(initList));	      
		 ...
		 * @
		 */
		public HashMap epce9000301_select5(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
			...
			if(vo != null ){
	    		...
	    		try {
					...
					rtnMap.put("selList", util.mapToJson(epce9000301Mapper.epce9000301_select4(inputMap)));
		 ...
		 * @
		 */
		public HashMap epce9000301_select5_1(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
			...
			if(vo != null ){
	    		...
	    		try {
					...
					rtnMap.put("selList", util.mapToJson(epce9000301Mapper.epce9000301_select4_1(inputMap)));
					rtnMap.put("totalList", util.mapToJson(epce9000301Mapper.epce9000301_select4_1_cnt(inputMap)));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
				}
		 ...
		 * @
		 */
		public String epce9000301_excel(HashMap<String, Object> data, HttpServletRequest request) {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
			...
			String errCd = "0000";
			try {
				List<?> list = epce9000301Mapper.epce9000301_select4(data);
		 ...
		 * @
		 */
		public String epce9000302_excel(HashMap<String, Object> data, HttpServletRequest request) {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
			...
			String errCd = "0000";
			try {
				List<?> list = epce9000301Mapper.epce9000301_select4_1(data);
		 ...
		 * @
		 */
		public String epce9000364_excel(HashMap<String, String> data, HttpServletRequest request) {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
			...
			String errCd = "0000";
			try {
				List<?> list = epce9000301Mapper.epce9000364_select2(data);
		 ...
		 * @
		 */
		public String epce9000301_delete(Map<String, String> inputMap,HttpServletRequest request) throws Exception  {
			String errCd = "0000";
...
//						}
						epce9000301Mapper.epce9000301_delete(map); // 반환내역서 삭제
					}
		 ...
		 * @
		 */
		public String epce9000301_update(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			List<?> list = JSONArray.fromObject(inputMap.get("list"));
			HttpSession session = request.getSession();
			...
			if (list != null) {
				try {
					for(int i=0; i<list.size(); i++){
						...
						int stat = epce9000301Mapper.epce9000301_select5(map); //상태 체크
						 if(stat>0){
						...
						epce9000301Mapper.epce9000301_insert(map); 		//실태조사요청정보 테이블에 등록
						epce9000301Mapper.epce9000301_update(map); 	// 반환내역서 실태조사
		 ...
		 * @
		 */
		public String epce9000301_update2(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			List<?> list = JSONArray.fromObject(inputMap.get("list"));
			HttpSession session = request.getSession();
			...
			if (list != null) {
				try {
					for(int i=0; i<list.size(); i++){
						...
						int stat = epce9000301Mapper.epce9000301_select7(map); //상태 체크
						...
						epce9000301Mapper.epce9000301_insert2(map); //반환등록요청 일괄확인
					}
				}catch (Exception e) {
					 if(e.getMessage().equals("A010")){
						 throw new Exception(e.getMessage());
		 ...
		 * @
		 */
		  public ModelMap epce9000364_select(ModelMap model, HttpServletRequest request) {
			  	HttpSession session = request.getSession();
				UserVO vo = (UserVO)session.getAttribute("userSession");
				...
				String title = commonceService.getMenuTitle("EPCE9000364");		//타이틀
				List<?> iniList = epce9000301Mapper.epce9000364_select(map);		//상세내역 조회
				List<?> gridList = epce9000301Mapper.epce9000364_select2(map);		//그리드쪽 조회
		  ...
		  /**
			...
			public String epce9000301_insert(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
					HttpSession session = request.getSession();
					UserVO vo = (UserVO) session.getAttribute("userSession");
					String errCd = "0000";
...
//								}
								int result = epce9000301Mapper.epce9000301_check(map);
								if(result == 1){
									cnt += 0;
								} else{
									cnt+=1;
							...
							for(int i=0; i<list.size(); i++){
								if(cnt == 0){
									...
									epce9000301Mapper.epce9000301_insert2(map); 	
								}else{
									errCd = "1111";
								}
							}
			 ...
			 */
		    @Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
			public String epce9000342_update(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
					HttpSession session = request.getSession();
					UserVO vo = (UserVO) session.getAttribute("userSession");
					String errCd = "0000";
...
//								}
								...
								if(result == 1){
							 	//detail
									epce9000301Mapper.epce9000342_update(map); 		// 반환상세
								}else{
									errCd = "1111";
								}
							}//end of for
			 ...
			 * @
			 */
			public HashMap epce9000331_select8(Map<String, String> inputMap, HttpServletRequest request) {
		    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		    	try {
					rtnMap.put("selList", util.mapToJson(epce9000301Mapper.epce9000331_select4(inputMap)));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
				}    	 
			...
			public List<?> rcs_nm_select(HttpServletRequest request, Map<String, String> data)  {
				...
				if(uvo.getBIZR_TP_CD().equals("W1")||uvo.getBIZR_TP_CD().equals("W2")){
					...
					selList = epce9000301Mapper.rcs_nm_select((Map<String, String>) map);//도매업자일경우
				}
				else{
					selList = epce9000301Mapper.rcs_nm_select_all((Map<String, String>) map);
				}
				
				return selList;
			}
			
		    public List<?> whsdlList(HttpServletRequest request, Map<String, String> data)  {
				...
				map.putAll(data);
					...
					selList = epce9000301Mapper.whsdlList((HashMap<String, String>) map);
