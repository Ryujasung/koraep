 ...
 *
 */
@Service("epce5599001Service")
public class EPCE5599001Service {
	 ...
	 * @
	 */
	public ModelMap epce55990012_select(ModelMap model, HttpServletRequest request) {
		...
		String title = commonceService.getMenuTitle("EPCE55990012");
	...
	public ModelMap epce55990422_select(ModelMap model, HttpServletRequest request) {
		
		String title = commonceService.getMenuTitle("EPCE55990422");
		model.addAttribute("titleSub", title);
