...
import egovframework.mapper.mf.ep.EPMF6151301Mapper;
 ...
 *
 */
@Service("epmf6151301Service")
public class EPMF6151301Service {  
	
	@Resource(name="epmf6151301Mapper")
	private EPMF6151301Mapper epmf6151301Mapper;
	 ...
	 * @
	 */
	  public ModelMap epmf6151301_select(ModelMap model, HttpServletRequest request) {
	   ...
	   * @
	   */
  	  public HashMap<String, Object> epmf6151301_select2(Map<String, String> data, HttpServletRequest request) {
			...
			try {
				List<?> list = epmf6151301Mapper.epmf6151301_select(data);
				map.put("searchList", util.mapToJson(list));
				
				if(data.get("CHART_YN") != null && data.get("CHART_YN").equals("Y")){
					List<?> list2 = epmf6151301Mapper.epmf6151301_select2(data);
					map.put("searchList2", util.mapToJson(list2));
				}
				map.put("totalList", epmf6151301Mapper.epmf6151301_select_cnt(data));
			} catch (Exception e) {
				// TODO Auto-generated catch block
				org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
			}
	  ...
	  /**
		 ...
		 * @
		 */
		public HashMap epmf6151301_select3(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public String epmf6151301_excel(HashMap<String, String> data, HttpServletRequest request) {
