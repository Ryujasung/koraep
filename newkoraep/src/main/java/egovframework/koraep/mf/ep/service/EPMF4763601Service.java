...
import egovframework.mapper.mf.ep.EPMF4763601Mapper;
 ...
 *
 */
@Service("epmf4763601Service")
public class EPMF4763601Service {

	@Resource(name="epmf4763601Mapper")
	private EPMF4763601Mapper epmf4763601Mapper;
	 ...
	 * @
	 */
	public ModelMap epmf4763601_select(ModelMap model, HttpServletRequest request) {
	 ...
	 * @
	 */
	public ModelMap epmf4763631_select(ModelMap model, HttpServletRequest request) {
		...
		String   title		= commonceService.getMenuTitle("EPMF4763631"); //타이틀
		List<?> mfcSeCdList = commonceService.mfc_bizrnm_select_y(request); // 생산자 콤보박스
	 ...
	 * @
	 */
	public ModelMap epmf4763642_select(ModelMap model, HttpServletRequest request) {
		...
		String   title		= commonceService.getMenuTitle("EPMF4763642"); //타이틀
		model.addAttribute("titleSub", title);
		...
		List<?> ctnrList = epmf6645231Mapper.epmf6645231_select5(map);
	 ...
	 * @
	 */
	public HashMap<String, Object> epmf4763601_select2(Map<String, String> data, HttpServletRequest request) {
		...
		List<?> list = epmf4763601Mapper.epmf4763601_select(data);
	 ...
	 * @
	 */
	public HashMap<String, Object> epmf4763601_select3(Map<String, String> data, HttpServletRequest request) {
	...
	public String epmf4763631_insert(Map<String, Object> inputMap,HttpServletRequest request) throws Exception  {
		HttpSession session = request.getSession();
		UserVO vo = (UserVO) session.getAttribute("userSession");
		String errCd = "0000";
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					/*정산기간 진행 체크*/
					int sel2 = epmf4763601Mapper.epmf4763631_select(map);
					if(sel2 < 1){
						 throw new Exception("A017");
					}
				 	
				 	/*중복체크*/
				 	int sel = epmf4763601Mapper.epmf4763631_select2(map);
					if(sel>0){
					...
					if(!map.containsKey("RMK")){
				 	...
				 	//detail
					epmf4763601Mapper.epmf4763631_insert(map); 	// 직접회수정정 등록
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	public String epmf4763642_update(Map<String, Object> inputMap, HttpServletRequest request) throws Exception  {
			...
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					if(!map.containsKey("RMK")){
				 	...
				 	//detail
					epmf4763601Mapper.epmf4763642_update(map); 	// 직접회수정정 수정
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	public String epmf4763601_delete(Map<String, Object> inputMap, HttpServletRequest request) throws Exception{
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					epmf4763601Mapper.epmf4763601_delete(map); //출고정정 삭제
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	public String epmf4763601_update(Map<String, Object> inputMap, HttpServletRequest request) throws Exception{
		...
		if (list != null) {
			try {
				...
				for(int i=0; i<list.size(); i++){
					...
					epmf4763601Mapper.epmf4763601_update(map); //출고정정 수정
	 ...
	 * @
	 */
	public String epmf4763601_excel(HashMap<String, String> data, HttpServletRequest request) {
