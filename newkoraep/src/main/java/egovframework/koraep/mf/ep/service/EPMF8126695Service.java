...
import egovframework.mapper.mf.ep.EPMF8126695Mapper;
 ...
 *
 */
@Service("epmf8126695Service")
public class EPMF8126695Service {
	
	@Resource(name="epmf8126695Mapper")
	private EPMF8126695Mapper epmf8126695Mapper;
	 ...
	 * @
	 */
	public ModelMap epmf8126695(ModelMap model, HttpServletRequest request) throws Exception  {
		
		String title = commonceService.getMenuTitle("EPMF8126695");	//타이틀
		...
		//공지사항 상세조회
		List<?> askInfo = epmf8126695Mapper.epmf8126695_select1(map);
		...
		List<?> ansrInfo = epmf8126695Mapper.epmf8126695_select2(map);
		if(null == ansrInfo) {
	 ...
	 */
	@Transactional
	public int epmf8126695_delete(Map<String, String> data, HttpServletRequest request)  {
		
		int result = 0;
		
		result += epmf8126695Mapper.epmf8126695_delete(data);
