...
import egovframework.mapper.mf.ep.EPMF6108701Mapper;
 ...
 *
 */
@Service("epmf6108701Service")
public class EPMF6108701Service {

	@Resource(name="epmf6108701Mapper")
	private EPMF6108701Mapper epmf6108701Mapper;
	 ...
	 * @
	 */
	  public ModelMap epmf6108701_select(ModelMap model, HttpServletRequest request) {
	   ...
	   * @
	   */
  	  public HashMap<String, Object> epmf6108701_select2(Map<String, Object> data, HttpServletRequest request) {
			...
			try {
				...
				List<?> list = epmf6108701Mapper.epmf6108701_select(data);
				map.put("searchList", util.mapToJson(list));

				if(data.get("CHART_YN") != null && data.get("CHART_YN").equals("Y")){
					List<?> list2 = epmf6108701Mapper.epmf6108701_select2(data);
					map.put("searchList2", util.mapToJson(list2));
				}

				map.put("totalList", epmf6108701Mapper.epmf6108701_select_cnt(data));
	  ...
	  /**
		 ...
		 * @
		 */
		public HashMap epmf6108701_select3(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public String epmf6108701_excel(HashMap<String, Object> data, HttpServletRequest request) {
