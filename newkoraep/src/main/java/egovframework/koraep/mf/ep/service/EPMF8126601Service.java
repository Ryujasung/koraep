...
import egovframework.mapper.mf.ep.EPMF8126601Mapper;
 ...
 *
 */
@Service("epmf8126601Service")
public class EPMF8126601Service {
	
	@Resource(name="epmf8126601Mapper")
	private EPMF8126601Mapper epmf8126601Mapper;
	 ...
	 * @
	 */
	public ModelMap epmf8126601(ModelMap model, HttpServletRequest request)  {
		...
		//문의/답변 총 게시글 수 조회
		List<?> totalCnt = epmf8126601Mapper.epmf8126601(map);
	 ...
	 * @
	 */
	public HashMap<String, Object> epmf8126601_select(Map<String, String> data, HttpServletRequest request)  {
		...
		//문의/답변 검색 게시글 수 조회
		List<?> totalCnt = epmf8126601Mapper.epmf8126601(data);
		
		//문의/답변 조회
		List<?> list = epmf8126601Mapper.epmf8126601_select(data);
