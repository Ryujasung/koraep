...
import egovframework.mapper.wh.ep.EPWH2983901Mapper;
 ...
 *
 */
@Service("epwh2983901Service")
public class EPWH2983901Service {


	@Resource(name="epwh2983901Mapper")
	private EPWH2983901Mapper epwh2983901Mapper;  //입고관리 Mapper
	 ...
	 * @
	 */
	  public ModelMap epwh2983901_select(ModelMap model, HttpServletRequest request) {
		  	//파라메터 정보
			...
			String   title = commonceService.getMenuTitle("EPWH2983901");//타이틀
			List<?>	whsdlList = commonceService.mfc_bizrnm_select4(request, map);// 생산자랑 거래중인 도매업자 업체명조회
			String   detail = "F";
			List<?> grid_info = commonceService.GRID_INFO_SELECT("EPWH2983901",request);//그리드 컬럼 정보
		 ...
		 * @
		 */
		public HashMap epwh2983901_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap epwh2983901_select3(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	    		try {
		 ...
		 * @
		 */
		public HashMap epwh2983901_select4(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		 ...
		 * @
		 */
		public HashMap epwh2983901_select5(Map<String, String> inputMap, HttpServletRequest request) {
	    	...
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	    		try {
					rtnMap.put("selList", util.mapToJson(epwh2983901Mapper.epwh2983901_select4(inputMap)));
					rtnMap.put("totalList", util.mapToJson(epwh2983901Mapper.epwh2983901_select4_cnt(inputMap)));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
				}
		 ...
		 * @
		 */
		public String epwh2983901_excel(HashMap<String, String> data, HttpServletRequest request) {
			...
			try {
				...
				List<?> list = epwh2983901Mapper.epwh2983901_select4(data);
				//엑셀파일 저장
		 ...
		 * @
		 */
		public String epwh2983901_update(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			...
			if (list != null) {  // 중복, 상태 확인
				for(int i=0; i<list.size(); i++){
					...
					int stat = epwh2983901Mapper.epwh2983901_select5(map); //상태 체크
					 if(stat>0){
				...
				try {
					for(int i=0; i<list.size(); i++){
						...
						if(map.get("RTN_STAT_CD").equals("RR")){
							...
							epwh2983901Mapper.epwh2983901_insert3(map); 		//실태조사요청정보 테이블에 등록
						}

							//실태조사중 반환등록 상태인경우 입고등록 이 안되있어서 반환내역서에만 반환상태 변경
							epwh2983901Mapper.epwh2983901_update(map); 	// 반환내역서 반환상태 변화
						if(map.get("CFM_CHECK").equals("T")){
							//입고조정 및 입고확인은 입고등록이 되어있어서 입고내역서도 반환상태 변경을 해야한다.
							epwh2983901Mapper.epwh2983901_update2(map); 	// 입고내역서 반환상태 변화
						}
		 ...
		 * @
		 */
		public String epwh2983901_update2(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
				...
				try {
					...
					for(int i=0; i<list.size(); i++){
						...
						map.put("REG_PRSN_ID", vo.getUSER_ID());  									//등록자
						 ...
						 epwh2983901Mapper.epwh2983901_insert(map); 							//	입고마스터	  등록

						 //detail
				 		epwh2983901Mapper.epwh2983901_insert2(map); 		// 입고상세
				 		list2.add(map); //list2에는 마스터에 등록된 문서 번호가 저장. 나중에 문서번호로만 업로드

					}//end of for

				 	for(int j=0 ;j<list2.size(); j++){
				 		Map<String, String> map_list2 = list2.get(j);
				 		map_list2.put("UPD_PRSN_ID", vo.getUSER_ID());  								//수정자
				 		epwh2983901Mapper.epwh2983901_update3(map_list2);			//입고 마스터 총값 넣기
				 		epwh2983901Mapper.epwh2983901_update4(map_list2); 			//반환 마스터  상태변경
				 	}
		 ...
		 * @
		 */
		  public ModelMap epwh2983964_select(ModelMap model, HttpServletRequest request) {
				...
				String   title					= commonceService.getMenuTitle("EPWH2983964");		//타이틀
				List<?> iniList				= epwh2983901Mapper.epwh2983964_select(map);		//상세내역 조회
				List<?> rtn_gridList			= epwh2983901Mapper.epwh2983964_select2(map);		//반환 그리드쪽 조회
				List<?> cfm_gridList		= epwh2983901Mapper.epwh2983964_select3(map);		//입고 그리드쪽 조회
		  ...
		  /**
			 ...
			 * @
			 */
			public HashMap epwh2983964_select2(Map<String, String> inputMap, HttpServletRequest request) {
		    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		    		try {
						rtnMap.put("iniList", util.mapToJson(epwh2983901Mapper.epwh2983964_select  (inputMap)));
					} catch (Exception e) {
						// TODO Auto-generated catch block
						org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
					}
			 ...
			 * @
			 */
			public String epwh2983964_update(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
				String errCd = "0000";
				Map<String, String> map;
				HttpSession session = request.getSession();
				UserVO vo = (UserVO) session.getAttribute("userSession");
					...
					try {
							int stat = epwh2983901Mapper.epwh2983901_select5(inputMap); //상태 체크
							 if(stat>0){
							...
							epwh2983901Mapper.epwh2983901_update2(inputMap); 	// 입고내역서 반환상태 변화
							epwh2983901Mapper.epwh2983901_update4(inputMap); 	// 반환내역서 반환상태 변화
			 ...
			 * @
			 */
			public String epwh2983964_update2(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
				String errCd = "0000";
				Map<String, String> map;
				HttpSession session = request.getSession();
				UserVO vo = (UserVO) session.getAttribute("userSession");
				...
				if (list != null) {
						try {
								for(int i=0; i<list.size(); i++){
										...
										inputMap.put("UPD_PRSN_ID", vo.getUSER_ID());  		//등록자
										epwh2983901Mapper.epwh2983964_update(map); 	//반환내역서 반환상태 변화
										epwh2983901Mapper.epwh2983964_delete(map); 		//입고증빙파일 테이블 삭제
										epwh2983901Mapper.epwh2983964_delete2(map); 	//입고상세 테이블 삭제
										epwh2983901Mapper.epwh2983964_delete3(map); 	//입고마스터 테이블 삭제
										if(map.get("RSRC_DOC_NO") !=null){
											epwh2983901Mapper.epwh2983964_delete4(map);	//실태조사증빙파일 테이블 삭제
											epwh2983901Mapper.epwh2983964_delete5(map);	//실태조사요청정보 테이블 삭제
										}
								}
						}catch (Exception e) {
							 if(e.getMessage().equals("A012")){
	...
	//---------------------------------------------------------------------------------------------------------------------
		 ...
		 * @
		 */
		public HashMap epwh2983988_select(Map<String, String> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
	    		String   title					= commonceService.getMenuTitle("EPWH2983988");		//타이틀
		 ...
		 * @
		 */
		public String epwh2983988_insert(Map<String, String> inputMap, HttpServletRequest request) throws Exception {
			String errCd = "0000";
			Map<String, String> map;
			HttpSession session = request.getSession();
			UserVO vo = (UserVO) session.getAttribute("userSession");
				...
				try {
						...
						epwh2983901Mapper.epwh2983988_insert(inputMap);								// 실태조사요청 저장
						epwh2983901Mapper.epwh2983988_update(inputMap);							// 반환관리,입고관리 반환상태 조사요청으로 변경
	...
	//---------------------------------------------------------------------------------------------------------------------
		  ...
		  /**
			 ...
			 * @
			 */
			public HashMap epwh29839883_select(Map<String, String> inputMap, HttpServletRequest request) {
		    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
		    		String   title					= commonceService.getMenuTitle("EPWH29839883");		//타이틀
		    		try {
						rtnMap.put("selList", util.mapToJson(epwh2983901Mapper.epwh29839883_select (inputMap)));
					} catch (Exception e) {
						// TODO Auto-generated catch block
						org.slf4j.LoggerFactory.getLogger(egovframework.common.AuthenticationFailHandlerImpl.class).debug("Exception Error");
					}
