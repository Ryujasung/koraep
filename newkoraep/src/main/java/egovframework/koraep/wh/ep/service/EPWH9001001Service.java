...
import egovframework.mapper.wh.ep.EPWH9001001Mapper;
 ...
 *
 */
@Service("epwh9001001Service")
public class EPWH9001001Service {


	@Resource(name="epwh9001001Mapper")
	private EPWH9001001Mapper epwh9001001Mapper;  //회수대비초과반환현황 Mapper
	 ...
	 * @
	 */
	  public ModelMap epwh9001001_select(ModelMap model, HttpServletRequest request) {

		  	String title = commonceService.getMenuTitle("EPWH9001001"); //화면 타이틀
		 ...
		 * @
		 */
		public HashMap epwh9001001_select2(Map<String, String> inputMap, HttpServletRequest request) {
		 ...
		 * @
		 */
		public HashMap epwh9001001_select3(Map<String, Object> inputMap, HttpServletRequest request) {
	    	HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    		...
    		try {
    			if( inputMap.get("CHART_YN") !=null && inputMap.get("CHART_YN").equals("Y") ){
    				...
    				rtnMap.put("selList_chart", util.mapToJson(epwh9001001Mapper.epwh9001001_select2(inputMap)));
	    	  	}
    			System.out.println("real?");
				rtnMap.put("selList", util.mapToJson(epwh9001001Mapper.epwh9001001_select(inputMap)));
//				rtnMap.put("totalList", util.mapToJson(epwh9001001Mapper.epwh9001001_select3(inputMap)));
		 ...
		 * @
		 */
		public String epwh9001001_excel(HashMap<String, Object> data, HttpServletRequest request) {
			...
			try {
				...
				List<?> list = epwh9001001Mapper.epwh9001001_select(data);
