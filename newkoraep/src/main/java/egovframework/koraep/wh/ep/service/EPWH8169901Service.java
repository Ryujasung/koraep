...
import egovframework.mapper.wh.ep.EPWH8169901Mapper;
 ...
 *
 */
@Service("epwh8169901Service")
public class EPWH8169901Service {
	
	@Resource(name="epwh8169901Mapper")
	private EPWH8169901Mapper epwh8169901Mapper;
	 ...
	 * @
	 */
	public ModelMap epwh8169901(ModelMap model, HttpServletRequest request)  {
		...
		//FAQ 총 게시글 수 조회
		List<?> totalCnt = epwh8169901Mapper.epwh8169901_select1(map);
	 ...
	 * @
	 */
	public HashMap<String, Object> epwh8169901_select(Map<String, String> data, HttpServletRequest request)  {
		...
		//FAQ 검색 게시글 수 조회
		List<?> totalCnt = epwh8169901Mapper.epwh8169901_select1(data);
		
		//FAQ 조회
		List<?> list = epwh8169901Mapper.epwh8169901_select2(data);

		//첨부파일 있는지 조회
		List<?> fileList = epwh8169901Mapper.epwh8169901_select3(data);
