...
import egovframework.mapper.wh.ep.EPWH8169998Mapper;
 ...
 *
 */
@Service("epwh8169998Service")
public class EPWH8169998Service {
	
	@Resource(name="epwh8169998Mapper")
	private EPWH8169998Mapper epwh8169998Mapper;
	 ...
	 * @
	 */
	public ModelMap epwh8169998(ModelMap model, HttpServletRequest request)  {
		...
		if(null != request.getParameter("FAQ_SEQ")){
			...
			//FAQ 상세조회
			askInfo = epwh8169998Mapper.epwh8169998_select2(inputMap);
			...
			//FAQ 첨부파일 조회
			fileList = epwh8169998Mapper.epwh8169998_select3(inputMap);
	 ...
	 */
	@Transactional
	public String epwh8169998_update(HashMap<String, String> inputMap, HttpServletRequest request) throws Exception {
...
//		MultipartHttpServletRequest mptRequest = (MultipartHttpServletRequest)request;
		...
		if(!inputMap.containsKey("FAQ_SEQ") || inputMap.get("FAQ_SEQ").equals("")){
			...
			List<?> seqList = epwh8169998Mapper.epwh8169998_select1();
			...
			//FAQ 등록
			epwh8169998Mapper.epwh8169998_update1(inputMap);
			...
			while (fileIter.hasNext()) {
				...
				if (mFile.getSize() > 0) {
					...
					epwh8169998Mapper.epwh8169998_update2(inputMap);
			...
			for(int i=0; i<delSeqList.length; i++) {
				...
				//삭제할 첨부파일 이름 조회
				List<?> delFile = epwh8169998Mapper.epwh8169998_select4(inputMap);
				...
				//첨부파일 테이블 삭제
				epwh8169998Mapper.epwh8169998_delete(inputMap);
				
			}
			
			//FAQ 수정
			epwh8169998Mapper.epwh8169998_update3(inputMap);
			...
			//FAQ 기존 첨부파일 리스트 조회
			List<?> filePre = epwh8169998Mapper.epwh8169998_select5(inputMap);
			...
			for(int i=0;i<filePre.size();i++){
				...
				epwh8169998Mapper.epwh8169998_update4(rtn);
