...
public class ImagePaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	public void initVariables(){
        ...
        /*
        firstPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&lt;&lt;<span class=\"hdd\">이전</span></a>";
        previousPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&lt;<span class=\"hdd\">이전</span></a>";
        currentPageLabel  = "<span><a href=\"#none\" class=\"on\">{0}</a>";
        otherPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">{2}</a></span>";
        nextPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&gt;<span class=\"hdd\">다음</span></a>";
        lastPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&gt;&gt;<span class=\"hdd\">마지막</span></a>";
        */
	}
